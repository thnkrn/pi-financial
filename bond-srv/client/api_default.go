...
func (r ApiFindAllRequest) Execute() (*FindAll200Response, *http.Response, error) {
...
func (a *DefaultAPIService) FindAllExecute(r ApiFindAllRequest) (*FindAll200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *FindAll200Response
	)
	...
	localVarPath := localBasePath + "/examples"
