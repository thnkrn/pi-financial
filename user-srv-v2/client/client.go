...
// APIClient manages communication with the Pi User Service V2 API v1.0
...
type APIClient struct {
	...
	SuitabilityTestAPI *SuitabilityTestAPIService

	TradingAccountAPI *TradingAccountAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.SuitabilityTestAPI = (*SuitabilityTestAPIService)(&c.common)
