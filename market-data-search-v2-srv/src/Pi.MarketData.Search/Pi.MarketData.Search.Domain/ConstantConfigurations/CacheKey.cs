...
public static class CacheKey
{
    ...
    public const string StreamingBody = "streaming-body-";
    public const string OrderBookId = "{order-book-id}:";
    public const string SetStreamingBody = "{set-str-streaming-body-}";
    ...
    public const string TickSizeTableEntry = "tick-size-table-entry-";
    public const string SetVenueMapping = "set-venue-mapping-";
    public const string MorningStarStocks = "morning-star-stocks-";
    public const string Instrument = "instrument-";
    public const string TradingSign = "trading-sign-";
}
