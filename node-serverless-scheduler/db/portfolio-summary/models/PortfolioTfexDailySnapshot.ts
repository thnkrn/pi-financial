...
export class PortfolioTfexDailySnapshot
  extends Model<
    InferCreationAttributes<PortfolioTfexDailySnapshot>,
    InferAttributes<PortfolioTfexDailySnapshot>
  >
...
export const initModel = (sequelize) => {
  PortfolioTfexDailySnapshot.init(
    {
      custcode: {
    ...
    {
      sequelize,
      tableName: 'portfolio_tfex_daily_snapshot',
      underscored: true,
      updatedAt: false,
    }
  );
