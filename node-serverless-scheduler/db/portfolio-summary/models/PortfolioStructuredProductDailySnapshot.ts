...
export class PortfolioStructuredProductDailySnapshot
  extends Model<
    InferCreationAttributes<PortfolioStructuredProductDailySnapshot>,
    InferAttributes<PortfolioStructuredProductDailySnapshot>
  >
...
export const initModel = (sequelize) => {
  PortfolioStructuredProductDailySnapshot.init(
    {
      custcode: {
    ...
    {
      sequelize,
      tableName: 'portfolio_structured_product_daily_snapshot',
      underscored: true,
      updatedAt: false,
    }
  );
