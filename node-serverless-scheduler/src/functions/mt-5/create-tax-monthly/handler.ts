...
const postCreateTaxMonthly = async () => {
  try {
    ...
    const response = await got
      .post(
        `${userSubscriptionServiceHost}/internal/tasks/tax-monthly-report`,
        {
          json: bodyData,
          headers: {
    ...
    console.error('Failed to create Tax Monthly\n' + JSON.stringify(e));
  }
};

export const main = middyfy(postCreateTaxMonthly);
