...
const settings = {
  ...
  fileName: 'CME Transaction Fee',
  filePrefix: 'MT5_CME_TRANSACTIONFEE_03',
...
const definition: Definition = {
  ...
  States: {
    ...
    ProcessFile: {
      ...
      ResultPath: '$.payload',
      Resource: { 'Fn::GetAtt': ['processTransactionFeeFile', 'Arn'] },
      Retry: [
        {
          ErrorEquals: ['Error'],
          IntervalSeconds: 60,
...
export const CMETransactionFee = {
  events: [
    {
      schedule: {
  ...
  iamRoleStatements: [],
  name: `pi-${process.env.AWS_ENVIRONMENT}-CMETransactionFee`,
  definition,
};
