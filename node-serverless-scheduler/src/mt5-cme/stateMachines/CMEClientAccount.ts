...
const settings = {
  fileName: 'CME Client Account',
  filePrefix: 'MT5_CME_ACC_03',
...
const definition: Definition = {
  ...
  States: {
    ProcessFile: {
      ...
      ResultPath: '$.payload',
      Resource: { 'Fn::GetAtt': ['processClientAccountFile', 'Arn'] },
      Next: 'ReportSuccess',
      Retry: [
        {
          ErrorEquals: ['Error'],
...
export const CMEClientAccount = {
  ...
  iamRoleStatements: [],
  name: `pi-${process.env.AWS_ENVIRONMENT}-CMEClientAccount`,
  definition,
};
