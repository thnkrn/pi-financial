...
const settings = {
  fileName: 'CME Trader Group',
  filePrefix: 'MT5_CME_TRADGRP_03',
...
const definition: Definition = {
  ...
  States: {
    ProcessFile: {
      ...
      ResultPath: '$.payload',
      Resource: { 'Fn::GetAtt': ['processTraderGroupFile', 'Arn'] },
      Next: 'ReportSuccess',
      Retry: [
        {
          ErrorEquals: ['Error'],
...
export const CMETraderGroup = {
  ...
  iamRoleStatements: [],
  name: `pi-${process.env.AWS_ENVIRONMENT}-CMETraderGroup`,
  definition,
};
