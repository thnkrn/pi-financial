...
import { traderGroupFileConfig } from '../../models/TraderGroupFile';
...
const run = async (event) => {
  ...
  try {
    ...
    const result = await pool.request().execute('get_cmetradergrp');
    ...
    const generator = new FixedLengthGenerator(traderGroupFileConfig);
