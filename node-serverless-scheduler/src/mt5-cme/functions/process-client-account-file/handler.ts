...
import { clientAccountFileConfig } from '../../models/ClientAccountFileConfig';
...
const run = async (event) => {
  ...
  try {
    ...
    const result = await pool.request().execute('get_cmeacctrade');
    ...
    const generator = new FixedLengthGenerator(clientAccountFileConfig);
