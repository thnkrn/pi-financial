...
namespace Pi.User.Migrations.Migrations
{
    ...
    [Migration("20241021100226_AddUserDbNewStructure")]
    partial class AddUserDbNewStructure
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.BankAccountAggregate.BankAccountV2", b =>
                {
                    ...
                    b.Property<Guid>("TradeAccountBankAccountId")
                        .HasColumnType("char(36)")
                        .HasColumnName("trade_account_bank_account_id");
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.TradeAccountBankAccountAggregate.TradeAccountBankAccount", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("id");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trade_account_bank_accounts");

                    b.HasIndex("BankAccountId")
                        .HasDatabaseName("ix_trade_account_bank_accounts_bank_account_id");

                    b.HasIndex("TradeAccountId")
                        .HasDatabaseName("ix_trade_account_bank_accounts_trade_account_id");

                    b.ToTable("trade_account_bank_accounts", (string)null);
                });
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.UserAccountAggregate.UserAccount", b =>
                {
                    ...
                    b.HasIndex("UserId1")
                        .HasDatabaseName("ix_user_accounts_user_id1");
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.ExternalAccountAggregate.ExternalAccount", b =>
                {
                    b.HasOne("Pi.User.Domain.AggregatesModel.TradeAccountAggregate.TradeAccount", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_external_accounts_trade_accounts_id");
                });
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.TradeAccountBankAccountAggregate.TradeAccountBankAccount", b =>
                {
                    b.HasOne("Pi.User.Domain.AggregatesModel.BankAccountAggregate.BankAccountV2", null)
                        .WithMany("TradeAccountBankAccounts")
                        .HasForeignKey("Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trade_account_bank_accounts_bank_account_v2s_id");
                    ...
                    b.HasOne("Pi.User.Domain.AggregatesModel.TradeAccountAggregate.TradeAccount", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_trade_account_bank_accounts_trade_accounts_trade_account_id");
                });
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.UserAccountAggregate.UserAccount", b =>
                {
                    ...
                    b.HasOne("Pi.User.Domain.AggregatesModel.UserInfoAggregate.UserInfo", "User")
                        ...
                        .HasConstraintName("fk_user_accounts_user_infos_user_id1");
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.BankAccountAggregate.BankAccountV2", b =>
                {
                    b.Navigation("TradeAccountBankAccounts");
                });
