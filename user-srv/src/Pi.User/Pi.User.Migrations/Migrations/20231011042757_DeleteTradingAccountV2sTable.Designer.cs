...
namespace Pi.User.Migrations.Migrations
{
    ...
    [Migration("20231011042757_DeleteTradingAccountV2sTable")]
    partial class DeleteTradingAccountV2sTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.UserInfoAggregate.TradingAccountV2", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<DateOnly?>("CreditLineEffectiveDate")
                        .HasColumnType("date")
                        .HasColumnName("credit_line_effective_date");

                    b.Property<DateOnly?>("CreditLineEndDate")
                        .HasColumnType("date")
                        .HasColumnName("credit_line_end_date");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_trading_accounts_v2");

                    b.HasIndex("CustomerCode")
                        .HasDatabaseName("ix_trading_accounts_v2_customer_code");

                    b.HasIndex("TradingAccountNo")
                        .HasDatabaseName("ix_trading_accounts_v2_trading_account_no");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_trading_accounts_v2_user_id");

                    b.ToTable("trading_accounts_v2", (string)null);
                });
            ...
            modelBuilder.Entity("Pi.User.Domain.AggregatesModel.UserInfoAggregate.TradingAccountV2", b =>
                {
                    b.HasOne("Pi.User.Domain.AggregatesModel.UserInfoAggregate.UserInfo", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .HasConstraintName("fk_trading_accounts_v2_user_infos_user_info_id");
                });
