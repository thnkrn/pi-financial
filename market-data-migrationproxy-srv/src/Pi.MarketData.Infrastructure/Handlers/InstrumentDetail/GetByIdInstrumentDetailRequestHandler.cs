...
using Pi.MarketData.Application.Queries.InstrumentDetail;
...
public class GetByIdInstrumentDetailRequestHandler : GetByIdInstrumentDetailRequestAbstractHandler
{
    ...
    public GetByIdInstrumentDetailRequestHandler(
        IMongoService<Domain.Entities.InstrumentDetail> instrumentDetailService)
    {
        _instrumentDetailService = instrumentDetailService;
    }

    protected override async Task<GetByIdInstrumentDetailResponse> Handle(GetByIdInstrumentDetailRequest request,
