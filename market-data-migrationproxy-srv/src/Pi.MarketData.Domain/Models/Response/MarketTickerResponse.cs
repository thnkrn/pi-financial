...
public class TickerBody
{
    ...
    [JsonPropertyName("auctionPrice")]
    public string? AuctionPrice { get; set; }

    [JsonPropertyName("auctionVolume")]
    ...
    [JsonPropertyName("priceChanged")]
    public string? PriceChanged { get; set; }

    [JsonPropertyName("priceChangedRate")]
    ...
    [JsonPropertyName("changeVolume")]
    public string? ChangeVolume { get; set; }

    [JsonPropertyName("turnoverRate")]
    public string? TurnoverRate { get; set; }

    [JsonPropertyName("open2")]
    ...
    [JsonPropertyName("averageBuy")]
    public string? AverageBuy { get; set; }

    [JsonPropertyName("averageSell")]
    ...
    [JsonPropertyName("totalAmountK")]
    public string? TotalAmountK { get; set; }

    [JsonPropertyName("totalVolume")]
    public string? TotalVolume { get; set; }

    [JsonPropertyName("totalVolumeK")]
    public string? TotalVolumeK { get; set; }

    [JsonPropertyName("tradableEquity")]
    public string? TradableEquity { get; set; }

    [JsonPropertyName("tradableAmount")]
    public string? TradableAmount { get; set; }

    [JsonPropertyName("eps")]
    public string? Eps { get; set; }

    [JsonPropertyName("publicTrades")]
    public List<List<object>>? PublicTrades { get; set; }

    [JsonPropertyName("orderBook")]
    public TickerOrderBook? OrderBook { get; set; }
    ...
    [JsonPropertyName("open0")]
    public string? Open0 { get; set; }

    [JsonPropertyName("open1")]
    ...
    [JsonPropertyName("isProjected")]
    public bool IsProjected { get; set; }

    [JsonPropertyName("lastPriceTime")]
...
public class TickerResponse
{
    ...
    public List<TickerBody>? Data { get; set; }
}
...
public class MarketTickerResponse
{
    ...
    public TickerResponse? Response { get; set; }
}
