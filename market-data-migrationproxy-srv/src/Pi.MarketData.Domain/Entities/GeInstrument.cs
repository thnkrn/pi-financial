...
public class GeInstrument
{
    ...
    [BsonElement("ge_instrument_id")] public int GeInstrumentId { get; set; }
    ...
    [BsonElement("symbol_type")] public string? SymbolType { get; set; }

    [BsonElement("currency")] public string? Currency { get; set; }

    [BsonElement("country")] public string? Country { get; set; }

    [BsonElement("figi")] public string? Figi { get; set; }

    [BsonElement("isin")] public string? Isin { get; set; }

    [BsonElement("mic")] public string? Mic { get; set; }

    [BsonElement("standard_ticker")] public string? StandardTicker { get; set; }

    [BsonElement("investment_type")] public string? InvestmentType { get; set; }
