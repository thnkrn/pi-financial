...
// checks if the PiMarketDataDomainModelsResponseOperatingMargin type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PiMarketDataDomainModelsResponseOperatingMargin{}

// PiMarketDataDomainModelsResponseOperatingMargin struct for PiMarketDataDomainModelsResponseOperatingMargin
type PiMarketDataDomainModelsResponseOperatingMargin struct {
...
func NewPiMarketDataDomainModelsResponseOperatingMargin() *PiMarketDataDomainModelsResponseOperatingMargin {
	this := PiMarketDataDomainModelsResponseOperatingMargin{}
	return &this
}
...
func (o *PiMarketDataDomainModelsResponseOperatingMargin) SetYyNil() {
	o.Yy.Set(nil)
}
...
func (o *PiMarketDataDomainModelsResponseOperatingMargin) SetStatementTypeNil() {
...
func (o PiMarketDataDomainModelsResponseOperatingMargin) MarshalJSON() ([]byte, error) {
...
func (o PiMarketDataDomainModelsResponseOperatingMargin) ToMap() (map[string]interface{}, error) {
...
type NullablePiMarketDataDomainModelsResponseOperatingMargin struct {
	value *PiMarketDataDomainModelsResponseOperatingMargin
	isSet bool
}

func (v NullablePiMarketDataDomainModelsResponseOperatingMargin) Get() *PiMarketDataDomainModelsResponseOperatingMargin {
	return v.value
}

func (v *NullablePiMarketDataDomainModelsResponseOperatingMargin) Set(val *PiMarketDataDomainModelsResponseOperatingMargin) {
	v.value = val
	v.isSet = true
}

func (v NullablePiMarketDataDomainModelsResponseOperatingMargin) IsSet() bool {
	return v.isSet
}

func (v *NullablePiMarketDataDomainModelsResponseOperatingMargin) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePiMarketDataDomainModelsResponseOperatingMargin(val *PiMarketDataDomainModelsResponseOperatingMargin) *NullablePiMarketDataDomainModelsResponseOperatingMargin {
	return &NullablePiMarketDataDomainModelsResponseOperatingMargin{value: val, isSet: true}
}

func (v NullablePiMarketDataDomainModelsResponseOperatingMargin) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePiMarketDataDomainModelsResponseOperatingMargin) UnmarshalJSON(src []byte) error {
	v.isSet = true
