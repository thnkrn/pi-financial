...
// checks if the PiMarketDataDomainModelsResponseLiabilitiesToAssets type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PiMarketDataDomainModelsResponseLiabilitiesToAssets{}

// PiMarketDataDomainModelsResponseLiabilitiesToAssets struct for PiMarketDataDomainModelsResponseLiabilitiesToAssets
type PiMarketDataDomainModelsResponseLiabilitiesToAssets struct {
...
func NewPiMarketDataDomainModelsResponseLiabilitiesToAssets() *PiMarketDataDomainModelsResponseLiabilitiesToAssets {
	this := PiMarketDataDomainModelsResponseLiabilitiesToAssets{}
	return &this
}
...
func (o *PiMarketDataDomainModelsResponseLiabilitiesToAssets) SetYyNil() {
	o.Yy.Set(nil)
}
...
func (o *PiMarketDataDomainModelsResponseLiabilitiesToAssets) SetStatementTypeNil() {
...
func (o PiMarketDataDomainModelsResponseLiabilitiesToAssets) MarshalJSON() ([]byte, error) {
...
func (o PiMarketDataDomainModelsResponseLiabilitiesToAssets) ToMap() (map[string]interface{}, error) {
...
type NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets struct {
	value *PiMarketDataDomainModelsResponseLiabilitiesToAssets
	isSet bool
}

func (v NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) Get() *PiMarketDataDomainModelsResponseLiabilitiesToAssets {
	return v.value
}

func (v *NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) Set(val *PiMarketDataDomainModelsResponseLiabilitiesToAssets) {
	v.value = val
	v.isSet = true
}

func (v NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) IsSet() bool {
	return v.isSet
}

func (v *NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePiMarketDataDomainModelsResponseLiabilitiesToAssets(val *PiMarketDataDomainModelsResponseLiabilitiesToAssets) *NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets {
	return &NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets{value: val, isSet: true}
}

func (v NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePiMarketDataDomainModelsResponseLiabilitiesToAssets) UnmarshalJSON(src []byte) error {
	v.isSet = true
