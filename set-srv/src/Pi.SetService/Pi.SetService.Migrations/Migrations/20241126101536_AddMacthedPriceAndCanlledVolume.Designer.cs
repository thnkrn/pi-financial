...
namespace Pi.SetService.Migrations.Migrations
{
    ...
    [Migration("20241126101536_AddMacthedPriceAndCanlledVolume")]
    partial class AddMacthedPriceAndCanlledVolume
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.SetService.Domain.AggregatesModel.TradingAggregate.EquityOrderState", b =>
                {
                    ...
                    b.Property<int?>("CancelledVolume")
                        .HasColumnType("int")
                        .HasColumnName("cancelled_volume");
            ...
            modelBuilder.Entity("Pi.SetService.Domain.AggregatesModel.TradingAggregate.SblOrder", b =>
                {
                    ...
                    b.HasIndex("Status")
                        .HasDatabaseName("ix_sbl_orders_status");
