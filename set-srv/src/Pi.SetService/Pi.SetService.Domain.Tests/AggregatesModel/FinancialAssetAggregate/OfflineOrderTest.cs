...
public class OfflineOrderTest
{
    ...
    {
        // Arrange
        var order = new OfflineOrder(123, "888888", "EA", OrderSide.Buy, ttf)
        {
            Price = 0,
            Volume = 0,
            EnterId = "9009",
    ...
    {
        // Arrange
        var order = new OfflineOrder(123, "888888", "EA", OrderSide.Buy, Ttf.None)
        {
            Price = 0,
            Volume = 0,
            EnterId = "9009",
    ...
    {
        // Arrange
        var order = new OfflineOrder(123, "888888", symbol, OrderSide.Buy, ttf)
        {
            Price = 0,
            Volume = 0,
            EnterId = "9009",
