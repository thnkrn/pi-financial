...
const Footer = ({ settings, footerStyles, footerContent: userFooterContent }: Props) => {
  ...
  return (
    ...
    >
      ...
      >
        {userFooterContent?.({ settings, footerStyles, footerContent: userFooterContent }) ?? <FooterContent />}
      </Box>
    </Box>
  )
}
