...
const OptionsMenu = ({ icon, options, menuProps, iconProps, leftAlignMenu, iconButtonProps }: OptionsMenuType) => {
      ...
      >
        {options.map((option: OptionType) => {
          if (typeof option === 'string') {
            ...
            return option.divider && <Divider key={option.text} {...option.dividerProps} />
          } else {
            return (
              <MenuItem
