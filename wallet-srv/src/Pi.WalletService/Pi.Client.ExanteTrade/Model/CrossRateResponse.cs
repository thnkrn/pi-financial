...
namespace Pi.Client.ExanteTrade.Model
{
    ...
    /// CrossRateResponse
    /// </summary>
    [DataContract(Name = "CrossRateResponse")]
    public partial class CrossRateResponse : IEquatable<CrossRateResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CrossRateResponse" /> class.
        /// </summary>
        /// <param name="pair">pair.</param>
        /// <param name="symbolId">symbolId.</param>
        /// <param name="rate">rate.</param>
        public CrossRateResponse(string pair = default(string), string symbolId = default(string), string rate = default(string))
        {
            this.Pair = pair;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CrossRateResponse {\n");
        ...
        {
            return this.Equals(input as CrossRateResponse);
        }

        /// <summary>
        /// Returns true if CrossRateResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CrossRateResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CrossRateResponse input)
        {
            if (input == null)
            {
                return false;
