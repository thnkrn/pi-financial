...
public class DepositEntrypointStateMap : SagaClassMap<DepositEntrypointState>
{
    public DepositEntrypointStateMap()
    {
    }

    protected override void Configure(EntityTypeBuilder<DepositEntrypointState> entity, ModelBuilder builder)
    {
        // Properties
        ...
        entity.Property(s => s.RefundId).HasMaxLength(36);
        ...
        entity.Property(s => s.BankAccountNo).HasMaxLength(250);
