...
public class AtsWithdrawStateMap : SagaClassMap<AtsWithdrawState>
{
    public AtsWithdrawStateMap()
    {
    }

    protected override void Configure(EntityTypeBuilder<AtsWithdrawState> entity, ModelBuilder model)
    {
