...
public class OddDepositStateMap : SagaClassMap<OddDepositState>
{
    public OddDepositStateMap()
    {
    }

    protected override void Configure(EntityTypeBuilder<OddDepositState> entity, ModelBuilder model)
    {
