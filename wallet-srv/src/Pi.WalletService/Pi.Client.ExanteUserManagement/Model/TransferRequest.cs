...
namespace Pi.Client.ExanteUserManagement.Model
{
    ...
    public partial class TransferRequest : IEquatable<TransferRequest>, IValidatableObject
    {
        ...
        public TransferRequest(string account = default(string), string secondAccount = default(string), string currency = default(string), decimal amount = default(decimal))
        {
