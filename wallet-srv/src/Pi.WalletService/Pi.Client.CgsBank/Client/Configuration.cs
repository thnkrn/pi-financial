...
namespace Pi.Client.CgsBank.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        public Configuration()
        {
            ...
            BasePath = "https://api-uat-bpgw.pi.financial";
            ...
            {
                {
                    new Dictionary<string, object> {
                        {"url", "https://api-uat-bpgw.pi.financial"},
        ...
        public Configuration(
            ...
            string basePath = "https://api-uat-bpgw.pi.financial") : this()
        {
        ...
        {
            string report = "C# SDK (Pi.Client.CgsBank) Debug Report:\n";
