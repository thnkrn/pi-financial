...
{
    /// <summary>
    /// QRPaymentResponseStatus
    /// </summary>
    [DataContract(Name = "QRPaymentResponse_status")]
    public partial class QRPaymentResponseStatus : IEquatable<QRPaymentResponseStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="QRPaymentResponseStatus" /> class.
        /// </summary>
        ...
        public QRPaymentResponseStatus(string externalStatusCode = default(string), string externalStatusDescription = default(string), string internalStatusCode = default(string), string internalStatusDescription = default(string), bool status = default(bool))
        {
        ...
        /// </summary>
        [DataMember(Name = "externalStatusCode", EmitDefaultValue = true)]
        public string ExternalStatusCode { get; set; }

        /// <summary>
        /// Gets or Sets ExternalStatusDescription
        /// </summary>
        [DataMember(Name = "externalStatusDescription", EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class QRPaymentResponseStatus {\n");
        ...
        {
            return this.Equals(input as QRPaymentResponseStatus);
        }

        /// <summary>
        /// Returns true if QRPaymentResponseStatus instances are equal
        /// </summary>
        /// <param name="input">Instance of QRPaymentResponseStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(QRPaymentResponseStatus input)
        {
            if (input == null)
            {
                return false;
