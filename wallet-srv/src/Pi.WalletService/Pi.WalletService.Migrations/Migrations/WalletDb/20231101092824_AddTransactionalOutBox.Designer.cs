...
namespace Pi.WalletService.Migrations.Migrations.WalletDb
{
    ...
    [Migration("20231101092824_AddTransactionalOutBox")]
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.CashAggregate.CashDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 198, DateTimeKind.Local).AddTicks(1820))
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.CashAggregate.CashWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 200, DateTimeKind.Local).AddTicks(7610))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositAggregate.DepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 195, DateTimeKind.Local).AddTicks(7160))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.LogAggregate.FreewillRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 203, DateTimeKind.Local).AddTicks(780))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WalletAggregate.TransactionHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 203, DateTimeKind.Local).AddTicks(1600))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WithdrawAggregate.WithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 11, 1, 16, 28, 24, 200, DateTimeKind.Local).AddTicks(5790))
                        .HasColumnName("created_at");
