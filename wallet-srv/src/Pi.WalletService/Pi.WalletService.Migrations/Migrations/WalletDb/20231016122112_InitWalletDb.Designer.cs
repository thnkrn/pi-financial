...
namespace Pi.WalletService.Migrations.Migrations.WalletDb
{
    ...
    [Migration("20231016122112_InitWalletDb")]
    partial class InitWalletDb
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.CashAggregate.CashDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 36, DateTimeKind.Local).AddTicks(8350))
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.CashAggregate.CashWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 39, DateTimeKind.Local).AddTicks(1340))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositAggregate.DepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 34, DateTimeKind.Local).AddTicks(3900))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.LogAggregate.FreewillRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 30, DateTimeKind.Local).AddTicks(3540))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WalletAggregate.TransactionHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 30, DateTimeKind.Local).AddTicks(4300))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WithdrawAggregate.WithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 10, 16, 19, 21, 12, 38, DateTimeKind.Local).AddTicks(9770))
                        .HasColumnName("created_at");
