...
namespace Pi.WalletService.Migrations.Migrations.WalletDb
{
    ...
    [Migration("20240612090134_AddEmailHistoryTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.AtsWithdrawAggregate.AtsWithdrawState", b =>
                {
                    b.Property<Guid>("CorrelationId")
                        .HasMaxLength(36)
                        .HasColumnType("char(36)")
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 762, DateTimeKind.Local).AddTicks(4720))
                        .HasColumnName("created_at");
                    ...
                    b.HasKey("CorrelationId")
                        .HasName("pk_ats_withdraw_state");

                    b.HasIndex("CorrelationId")
                        .IsUnique()
                        .HasDatabaseName("ix_ats_withdraw_state_correlation_id");

                    b.ToTable("ats_withdraw_state", (string)null);
                });
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositAggregate.DepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 738, DateTimeKind.Local).AddTicks(6360))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositEntrypointAggregate.DepositEntrypointState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 745, DateTimeKind.Local).AddTicks(6740))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.GlobalTransfer.GlobalTransferState", b =>
                {
                    ...
                    b.Property<decimal?>("ActualFxRate")
                        .HasPrecision(65, 30)
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("actual_fx_rate");
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 758, DateTimeKind.Local).AddTicks(7800))
                        .HasColumnName("created_at");
                    ...
                    b.Property<decimal?>("FxConfirmedExchangeAmount")
                        .HasPrecision(65, 30)
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("fx_confirmed_exchange_amount");

                    b.Property<string>("FxConfirmedExchangeCurrency")
                        .HasColumnType("longtext")
                        .HasColumnName("fx_confirmed_exchange_currency");
                    ...
                    b.Property<decimal>("FxMarkUpRate")
                        .HasPrecision(65, 30)
                        .HasColumnType("decimal(65,30)")
                        .HasColumnName("fx_mark_up_rate");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.LogAggregate.FreewillRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 764, DateTimeKind.Local).AddTicks(9410))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddDepositAggregate.OddDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 755, DateTimeKind.Local).AddTicks(3630))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddWithdrawAggregate.OddWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 756, DateTimeKind.Local).AddTicks(2430))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.QrDepositAggregate.QrDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 754, DateTimeKind.Local).AddTicks(4220))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.RefundInfoAggregate.RefundInfo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 765, DateTimeKind.Local).AddTicks(6900))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.UpBackAggregate.UpBackState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 756, DateTimeKind.Local).AddTicks(8010))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.UtilityAggregate.EmailHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(36)
                    ...
                    b.HasKey("Id")
                        .HasName("pk_email_history");

                    b.HasIndex("TransactionNo")
                        .HasDatabaseName("ix_email_history_transaction_no");

                    b.ToTable("email_history", (string)null);
                });

            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.UtilityAggregate.Holiday", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            HolidayDate = new DateOnly(2024, 1, 2),
                            HolidayName = "Substitution for New Year’s Eve (Sunday 31st December 2023) (cancelled)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 2, 26),
                            HolidayName = "Substitution for Makha Bucha Day (Saturday 24th February 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 4, 8),
                            HolidayName = "Substitution for Chakri Memorial Day (Saturday 6th April 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 4, 12),
                            HolidayName = "Additional special holiday (added)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 4, 15),
                            HolidayName = "Songkran Festival",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 4, 16),
                            HolidayName = "Substitution for Songkran Festival (Saturday 13th April 2024 and Sunday 14th April 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 5, 1),
                            HolidayName = "National Labour Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 5, 6),
                            HolidayName = "Substitution for Coronation Day (Saturday 4th May 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 5, 22),
                            HolidayName = "Visakha Bucha Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 6, 3),
                            HolidayName = "H.M. Queen Suthida Bajrasudhabimalalakshana’s Birthday",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 7, 22),
                            HolidayName = "Substitution for Asarnha Bucha Day (Saturday 20th July 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 7, 29),
                            HolidayName = "Substitution for H.M. King Maha Vajiralongkorn Phra Vajiraklaochaoyuhua’s Birthday (Sunday 28th July 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 8, 12),
                            HolidayName = "H.M. Queen Sirikit The Queen Mother’s Birthday / Mother’s Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 10, 14),
                            HolidayName = "Substitution for H.M. King Bhumibol Adulyadej The Great Memorial Day (Sunday 13th October 2024)",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 10, 23),
                            HolidayName = "H.M. King Chulalongkorn The Great Memorial Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 12, 5),
                            HolidayName = "H.M. King Bhumibol Adulyadej The Great’s Birthday / National Day / Father’s Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 12, 10),
                            HolidayName = "Constitution Day",
                            Valid = true
                        },
                        new
                        {
                            HolidayDate = new DateOnly(2024, 12, 31),
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WalletAggregate.TransactionHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 765, DateTimeKind.Local).AddTicks(8270))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WithdrawAggregate.WithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 6, 12, 16, 1, 34, 742, DateTimeKind.Local).AddTicks(8410))
                        .HasColumnName("created_at");
