...
namespace Pi.WalletService.Migrations.Migrations.WalletDb
{
    ...
    [Migration("20240403064636_EncryptRefundInfo")]
    partial class EncryptRefundInfo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositAggregate.DepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 591, DateTimeKind.Local).AddTicks(6390))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositEntrypointAggregate.DepositEntrypointState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 601, DateTimeKind.Local).AddTicks(590))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.GlobalTransfer.GlobalTransferState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 608, DateTimeKind.Local).AddTicks(2700))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.LogAggregate.FreewillRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 619, DateTimeKind.Local).AddTicks(1970))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddDepositAggregate.OddDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 603, DateTimeKind.Local).AddTicks(8820))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddWithdrawAggregate.OddWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 605, DateTimeKind.Local).AddTicks(1790))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.QrDepositAggregate.QrDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 602, DateTimeKind.Local).AddTicks(4730))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.RefundInfoAggregate.RefundInfo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 619, DateTimeKind.Local).AddTicks(2520))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.UpBackAggregate.UpBackState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 605, DateTimeKind.Local).AddTicks(9540))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WalletAggregate.TransactionHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 619, DateTimeKind.Local).AddTicks(3400))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WithdrawAggregate.WithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 4, 3, 13, 46, 36, 597, DateTimeKind.Local).AddTicks(2830))
                        .HasColumnName("created_at");
