...
namespace Pi.WalletService.Migrations.Migrations.WalletDb
{
    ...
    [Migration("20240527100252_AddActualFxRate")]
    partial class AddActualFxRate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.AtsWithdrawAggregate.AtsWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 902, DateTimeKind.Local).AddTicks(2230))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositAggregate.DepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 880, DateTimeKind.Local).AddTicks(5360))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.DepositEntrypointAggregate.DepositEntrypointState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 888, DateTimeKind.Local).AddTicks(8730))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.GlobalTransfer.GlobalTransferState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 895, DateTimeKind.Local).AddTicks(7500))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.LogAggregate.FreewillRequestLog", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 904, DateTimeKind.Local).AddTicks(9140))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddDepositAggregate.OddDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 891, DateTimeKind.Local).AddTicks(4470))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.OddWithdrawAggregate.OddWithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 892, DateTimeKind.Local).AddTicks(5580))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.QrDepositAggregate.QrDepositState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 890, DateTimeKind.Local).AddTicks(2910))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.RefundInfoAggregate.RefundInfo", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 905, DateTimeKind.Local).AddTicks(8330))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.UpBackAggregate.UpBackState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 893, DateTimeKind.Local).AddTicks(2310))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WalletAggregate.TransactionHistory", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 905, DateTimeKind.Local).AddTicks(9990))
                        .HasColumnName("created_at");
            ...
            modelBuilder.Entity("Pi.WalletService.Domain.AggregatesModel.WithdrawAggregate.WithdrawState", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedAt")
                        ...
                        .HasMaxLength(6)
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2024, 5, 27, 17, 2, 51, 885, DateTimeKind.Local).AddTicks(3920))
                        .HasColumnName("created_at");
