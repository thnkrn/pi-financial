...
// checks if the InternalAddressProvinceGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalAddressProvinceGet200Response{}

// InternalAddressProvinceGet200Response struct for InternalAddressProvinceGet200Response
type InternalAddressProvinceGet200Response struct {
	Detail *string           `json:"detail,omitempty"`
	Status *int32            `json:"status,omitempty"`
	Title  *string           `json:"title,omitempty"`
	Data   []AddressProvince `json:"data,omitempty"`
}
...
func NewInternalAddressProvinceGet200Response() *InternalAddressProvinceGet200Response {
	this := InternalAddressProvinceGet200Response{}
	return &this
}
...
// SetData gets a reference to the given []AddressProvince and assigns it to the Data field.
func (o *InternalAddressProvinceGet200Response) SetData(v []AddressProvince) {
	o.Data = v
}

func (o InternalAddressProvinceGet200Response) MarshalJSON() ([]byte, error) {
...
func (o InternalAddressProvinceGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableInternalAddressProvinceGet200Response struct {
	value *InternalAddressProvinceGet200Response
	isSet bool
}

func (v NullableInternalAddressProvinceGet200Response) Get() *InternalAddressProvinceGet200Response {
	return v.value
}

func (v *NullableInternalAddressProvinceGet200Response) Set(val *InternalAddressProvinceGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalAddressProvinceGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalAddressProvinceGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalAddressProvinceGet200Response(val *InternalAddressProvinceGet200Response) *NullableInternalAddressProvinceGet200Response {
	return &NullableInternalAddressProvinceGet200Response{value: val, isSet: true}
}

func (v NullableInternalAddressProvinceGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalAddressProvinceGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
