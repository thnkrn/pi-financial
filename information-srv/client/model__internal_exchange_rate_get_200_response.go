...
// checks if the InternalExchangeRateGet200Response type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &InternalExchangeRateGet200Response{}

// InternalExchangeRateGet200Response struct for InternalExchangeRateGet200Response
type InternalExchangeRateGet200Response struct {
	Detail *string                    `json:"detail,omitempty"`
	Status *int32                     `json:"status,omitempty"`
	Title  *string                    `json:"title,omitempty"`
	Data   []HttpExchangeRateResponse `json:"data,omitempty"`
}
...
func NewInternalExchangeRateGet200Response() *InternalExchangeRateGet200Response {
	this := InternalExchangeRateGet200Response{}
	return &this
}
...
func (o *InternalExchangeRateGet200Response) GetData() []HttpExchangeRateResponse {
	if o == nil || IsNil(o.Data) {
		var ret []HttpExchangeRateResponse
		return ret
	}
	return o.Data
}
...
// SetData gets a reference to the given []HttpExchangeRateResponse and assigns it to the Data field.
func (o *InternalExchangeRateGet200Response) SetData(v []HttpExchangeRateResponse) {
	o.Data = v
}

func (o InternalExchangeRateGet200Response) MarshalJSON() ([]byte, error) {
...
func (o InternalExchangeRateGet200Response) ToMap() (map[string]interface{}, error) {
...
type NullableInternalExchangeRateGet200Response struct {
	value *InternalExchangeRateGet200Response
	isSet bool
}

func (v NullableInternalExchangeRateGet200Response) Get() *InternalExchangeRateGet200Response {
	return v.value
}

func (v *NullableInternalExchangeRateGet200Response) Set(val *InternalExchangeRateGet200Response) {
	v.value = val
	v.isSet = true
}

func (v NullableInternalExchangeRateGet200Response) IsSet() bool {
	return v.isSet
}

func (v *NullableInternalExchangeRateGet200Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInternalExchangeRateGet200Response(val *InternalExchangeRateGet200Response) *NullableInternalExchangeRateGet200Response {
	return &NullableInternalExchangeRateGet200Response{value: val, isSet: true}
}

func (v NullableInternalExchangeRateGet200Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInternalExchangeRateGet200Response) UnmarshalJSON(src []byte) error {
	v.isSet = true
