...
//
//	mockgen -package mocks -source=cache.go -destination=../../../mocks/ports_mock/cache_mock.go
//
...
func (mr *MockCacheRepositoryMockRecorder) Get(key any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Get", reflect.TypeOf((*MockCacheRepository)(nil).Get), key)
}

// Set mocks base method.
func (m *MockCacheRepository) Set(key, value string, ttl time.Duration) error {
	m.ctrl.T.Helper()
...
func (mr *MockCacheRepositoryMockRecorder) Set(key, value, ttl any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Set", reflect.TypeOf((*MockCacheRepository)(nil).Set), key, value, ttl)
}
