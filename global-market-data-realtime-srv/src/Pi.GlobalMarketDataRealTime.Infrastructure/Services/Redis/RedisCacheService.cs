...
using MSD = Microsoft.Extensions.Caching.Distributed;
...
{
    private readonly MSD.IDistributedCache _distributedCache;
    private readonly string _redisKeyspace;

    public RedisCacheService(MSD.IDistributedCache distributedCache, IConfiguration configuration)
    {
