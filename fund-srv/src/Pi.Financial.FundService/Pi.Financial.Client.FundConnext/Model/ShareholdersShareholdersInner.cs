...
{
    /// <summary>
    /// ShareholdersShareholdersInner
    /// </summary>
    [DataContract(Name = "Shareholders_shareholders_inner")]
    public partial class ShareholdersShareholdersInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ShareholdersShareholdersInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ShareholdersShareholdersInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ShareholdersShareholdersInner" /> class.
        /// </summary>
        ...
        public ShareholdersShareholdersInner(TypeEnum type = default(TypeEnum), string nationality = default(string), IdentificationCardTypeEnum? identificationCardType = default(IdentificationCardTypeEnum?), string passportCountry = default(string), string cardNumber = default(string), string cardExpiryDate = default(string), string firstName = default(string), string lastName = default(string), string juristicNumber = default(string), string registeredCountryCode = default(string), List<ShareholdersShareholdersInner> shareholders = default(List<ShareholdersShareholdersInner>))
        {
            this.Type = type;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for ShareholdersShareholdersInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShareholdersShareholdersInner {\n");
