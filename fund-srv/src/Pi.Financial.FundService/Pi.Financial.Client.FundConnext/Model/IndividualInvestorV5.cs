...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IndividualInvestorV5")]
    public partial class IndividualInvestorV5 : IValidatableObject
    {
        /// <summary>
        ...
        /// </summary>
        /// <value>CDD Score&lt;/br&gt;(1-3)&lt;/br&gt;</value>
        [DataMember(Name = "cddScore", EmitDefaultValue = true)]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualInvestorV5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndividualInvestorV5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualInvestorV5" /> class.
        /// </summary>
        ...
        /// <param name="openFundConnextFormFlag">มีการกรอกแบบฟอร์ม FundConnext แล้วหรือไม่&lt;/br&gt;Y &#x3D; แบบฟอร์ม FundConnext เดิม&lt;/br&gt;N &#x3D; ยังไม่ได้กรอกแบบฟอร์ม FundConnext&lt;/br&gt;S &#x3D; แบบฟอร์ม FundConnext (Single Form)&lt;/br&gt; (required).</param>
        ...
        /// <param name="approved">รายการที่ส่งมาถูก approve มาแล้วหรือไม่&lt;/br&gt;true - approve แล้ว&lt;/br&gt;false - ยังไม่ได้ approve&lt;/br&gt;default &#x3D; false&lt;/br&gt;*ต้องใส่ค่ากรณี เปิด/แก้ไข&lt;/br&gt;*ไม่มีค่ากรณีเป็น Response จาก FundConnext (required).</param>
        ...
        public IndividualInvestorV5(IdentificationCardTypeEnum identificationCardType = default(IdentificationCardTypeEnum), string passportCountry = default(string), IndividualInvestorV5ResponseCardNumber cardNumber = default(IndividualInvestorV5ResponseCardNumber), IndividualInvestorV5ResponseCardExpiryDate cardExpiryDate = default(IndividualInvestorV5ResponseCardExpiryDate), AccompanyingDocumentEnum? accompanyingDocument = default(AccompanyingDocumentEnum?), TitleEnum title = default(TitleEnum), string titleOther = default(string), string enFirstName = default(string), string enLastName = default(string), string thFirstName = default(string), string thLastName = default(string), string birthDate = default(string), string nationality = default(string), string mobileNumber = default(string), string email = default(string), string phone = default(string), string fax = default(string), MaritalStatusEnum maritalStatus = default(MaritalStatusEnum), Spouse spouse = default(Spouse), OccupationId occupationId = default(OccupationId), string occupationOther = default(string), BusinessTypeId? businessTypeId = default(BusinessTypeId?), string businessTypeOther = default(string), MonthlyIncomeLevel monthlyIncomeLevel = default(MonthlyIncomeLevel), decimal? assetValue = default(decimal?), string incomeSource = default(string), string incomeSourceOther = default(string), IndividualInvestorV5ResponseIdentificationDocument identificationDocument = default(IndividualInvestorV5ResponseIdentificationDocument), CurrentAddressSameAsFlagEnum? currentAddressSameAsFlag = default(CurrentAddressSameAsFlagEnum?), IndividualInvestorV5ResponseCurrent current = default(IndividualInvestorV5ResponseCurrent), string companyName = default(string), IndividualInvestorV5ResponseWork work = default(IndividualInvestorV5ResponseWork), string workPosition = default(string), bool? relatedPoliticalPerson = default(bool?), string politicalRelatedPersonPosition = default(string), bool canAcceptFxRisk = default(bool), bool canAcceptDerivativeInvestment = default(bool), IndividualInvestorV5ResponseSuitabilityRiskLevel suitabilityRiskLevel = default(IndividualInvestorV5ResponseSuitabilityRiskLevel), string suitabilityEvaluationDate = default(string), bool fatca = default(bool), string fatcaDeclarationDate = default(string), string crsPlaceOfBirthCountry = default(string), string crsPlaceOfBirthCity = default(string), bool crsTaxResidenceInCountriesOtherThanTheUS = default(bool), List<CustomerAccountCreateRequestV5CrsDetailsInner> crsDetails = default(List<CustomerAccountCreateRequestV5CrsDetailsInner>), string crsDeclarationDate = default(string), CddScoreEnum? cddScore = default(CddScoreEnum?), string cddDate = default(string), string referralPerson = default(string), string applicationDate = default(string), string incomeSourceCountry = default(string), string acceptedBy = default(string), OpenFundConnextFormFlagEnum openFundConnextFormFlag = default(OpenFundConnextFormFlagEnum), bool? vulnerableFlag = default(bool?), string vulnerableDetail = default(string), bool? ndidFlag = default(bool?), string ndidRequestId = default(string), OpenChannelEnum openChannel = default(OpenChannelEnum), bool approved = default(bool), IndividualInvestorV5ResponseSuitabilityForm suitabilityForm = default(IndividualInvestorV5ResponseSuitabilityForm), InvestorClassEnum? investorClass = default(InvestorClassEnum?), bool? knowledgeAssessmentResult = default(bool?), IndividualInvestorV5ResponseKnowledgeAssessmentForm knowledgeAssessmentForm = default(IndividualInvestorV5ResponseKnowledgeAssessmentForm))
        {
            ...
            if (enFirstName == null)
            {
                throw new ArgumentNullException("enFirstName is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.EnFirstName = enFirstName;
            // to ensure "enLastName" is required (not null)
            if (enLastName == null)
            {
                throw new ArgumentNullException("enLastName is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.EnLastName = enLastName;
            // to ensure "thFirstName" is required (not null)
            if (thFirstName == null)
            {
                throw new ArgumentNullException("thFirstName is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.ThFirstName = thFirstName;
            // to ensure "thLastName" is required (not null)
            if (thLastName == null)
            {
                throw new ArgumentNullException("thLastName is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.ThLastName = thLastName;
            // to ensure "birthDate" is required (not null)
            if (birthDate == null)
            {
                throw new ArgumentNullException("birthDate is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.BirthDate = birthDate;
            // to ensure "nationality" is required (not null)
            if (nationality == null)
            {
                throw new ArgumentNullException("nationality is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.Nationality = nationality;
            // to ensure "mobileNumber" is required (not null)
            if (mobileNumber == null)
            {
                throw new ArgumentNullException("mobileNumber is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("incomeSource is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.IncomeSource = incomeSource;
            // to ensure "identificationDocument" is required (not null)
            if (identificationDocument == null)
            {
                throw new ArgumentNullException("identificationDocument is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("suitabilityRiskLevel is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("suitabilityEvaluationDate is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("fatcaDeclarationDate is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("crsPlaceOfBirthCountry is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("crsPlaceOfBirthCity is a required property for IndividualInvestorV5 and cannot be null");
            }
            ...
            if (crsDetails == null)
            {
                throw new ArgumentNullException("crsDetails is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.CrsDetails = crsDetails;
            // to ensure "crsDeclarationDate" is required (not null)
            if (crsDeclarationDate == null)
            {
                throw new ArgumentNullException("crsDeclarationDate is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.CrsDeclarationDate = crsDeclarationDate;
            // to ensure "applicationDate" is required (not null)
            if (applicationDate == null)
            {
                throw new ArgumentNullException("applicationDate is a required property for IndividualInvestorV5 and cannot be null");
            }
            this.ApplicationDate = applicationDate;
            // to ensure "incomeSourceCountry" is required (not null)
            if (incomeSourceCountry == null)
            {
                throw new ArgumentNullException("incomeSourceCountry is a required property for IndividualInvestorV5 and cannot be null");
            }
        ...
        /// <summary>
        /// รายการที่ส่งมาถูก approve มาแล้วหรือไม่&lt;/br&gt;true - approve แล้ว&lt;/br&gt;false - ยังไม่ได้ approve&lt;/br&gt;default &#x3D; false&lt;/br&gt;*ต้องใส่ค่ากรณี เปิด/แก้ไข&lt;/br&gt;*ไม่มีค่ากรณีเป็น Response จาก FundConnext
        /// </summary>
        /// <value>รายการที่ส่งมาถูก approve มาแล้วหรือไม่&lt;/br&gt;true - approve แล้ว&lt;/br&gt;false - ยังไม่ได้ approve&lt;/br&gt;default &#x3D; false&lt;/br&gt;*ต้องใส่ค่ากรณี เปิด/แก้ไข&lt;/br&gt;*ไม่มีค่ากรณีเป็น Response จาก FundConnext</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IndividualInvestorV5 {\n");
