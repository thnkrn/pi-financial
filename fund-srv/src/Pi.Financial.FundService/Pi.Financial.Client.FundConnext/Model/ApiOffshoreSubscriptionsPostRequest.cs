...
{
    /// <summary>
    /// ApiOffshoreSubscriptionsPostRequest
    /// </summary>
    [DataContract(Name = "_api_offshore_subscriptions_post_request")]
    public partial class ApiOffshoreSubscriptionsPostRequest : IValidatableObject
    {
        /// <summary>
        ...
        /// [N] - no fx settlement
        /// </summary>
        /// <value>[N] - no fx settlement</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum FxSettlementEnum
        {
            /// <summary>
            /// Enum N for value: N
            /// </summary>
        ...
        /// </summary>
        /// <value>[N] - no fx settlement</value>
        [DataMember(Name = "fxSettlement", IsRequired = true, EmitDefaultValue = true)]
        public FxSettlementEnum FxSettlement { get; set; }
        /// <summary>
        /// [COL_SA] &#x3D; Collateral to SA&lt;/br&gt;[COL_SA_F] &#x3D; Collateral to SA at offshore bank
        /// </summary>
        /// <value>[COL_SA] &#x3D; Collateral to SA&lt;/br&gt;[COL_SA_F] &#x3D; Collateral to SA at offshore bank</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum PaymentTypeEnum
        {
            /// <summary>
            /// Enum SA for value: COL_SA
            /// </summary>
            [EnumMember(Value = "COL_SA")]
            SA = 1,

            /// <summary>
            /// Enum SAF for value: COL_SA_F
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiOffshoreSubscriptionsPostRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ApiOffshoreSubscriptionsPostRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiOffshoreSubscriptionsPostRequest" /> class.
        /// </summary>
        ...
        /// <param name="amount">Decimal point for each currency refers to minorunit in ISO4217 (required).</param>
        /// <param name="effectiveDate">Format: YYYYMMDD (required).</param>
        /// <param name="fxSettlement">[N] - no fx settlement (required).</param>
        /// <param name="paymentType">[COL_SA] &#x3D; Collateral to SA&lt;/br&gt;[COL_SA_F] &#x3D; Collateral to SA at offshore bank (required).</param>
        ...
        /// <param name="frontendFee">Frontend fee charge customer by SA. This fee will deduct from amount. Defaulted fee will be appliedif not filled.</param>
        public ApiOffshoreSubscriptionsPostRequest(string saOrderReferenceNo = default(string), string transactionDateTime = default(string), string saCode = default(string), string accountId = default(string), OverrideRiskProfileEnum overrideRiskProfile = default(OverrideRiskProfileEnum), string platform = default(string), string isin = default(string), string currency = default(string), decimal amount = default(decimal), string effectiveDate = default(string), FxSettlementEnum fxSettlement = default(FxSettlementEnum), PaymentTypeEnum paymentType = default(PaymentTypeEnum), string bankCode = default(string), string bankAccount = default(string), ChannelEnum channel = default(ChannelEnum), string icLicense = default(string), string branchNo = default(string), StatusEnum? status = default(StatusEnum?), string collateralAccount = default(string), decimal? frontendFee = default(decimal?))
        {
            // to ensure "saOrderReferenceNo" is required (not null)
            if (saOrderReferenceNo == null)
            {
                throw new ArgumentNullException("saOrderReferenceNo is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            this.SaOrderReferenceNo = saOrderReferenceNo;
            // to ensure "transactionDateTime" is required (not null)
            if (transactionDateTime == null)
            {
                throw new ArgumentNullException("transactionDateTime is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            this.TransactionDateTime = transactionDateTime;
            // to ensure "saCode" is required (not null)
            if (saCode == null)
            {
                throw new ArgumentNullException("saCode is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            this.SaCode = saCode;
            // to ensure "accountId" is required (not null)
            if (accountId == null)
            {
                throw new ArgumentNullException("accountId is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            ...
            if (platform == null)
            {
                throw new ArgumentNullException("platform is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            this.Platform = platform;
            // to ensure "isin" is required (not null)
            if (isin == null)
            {
                throw new ArgumentNullException("isin is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            this.Isin = isin;
            // to ensure "currency" is required (not null)
            if (currency == null)
            {
                throw new ArgumentNullException("currency is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("effectiveDate is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
            ...
            if (icLicense == null)
            {
                throw new ArgumentNullException("icLicense is a required property for ApiOffshoreSubscriptionsPostRequest and cannot be null");
            }
        ...
        /// <summary>
        /// Decimal point for each currency refers to minorunit in ISO4217
        /// </summary>
        /// <value>Decimal point for each currency refers to minorunit in ISO4217</value>
        ...
        /// <summary>
        /// Frontend fee charge customer by SA. This fee will deduct from amount. Defaulted fee will be appliedif not filled
        /// </summary>
        /// <value>Frontend fee charge customer by SA. This fee will deduct from amount. Defaulted fee will be appliedif not filled</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiOffshoreSubscriptionsPostRequest {\n");
            ...
            sb.Append("  FxSettlement: ").Append(FxSettlement).Append("\n");
        ...
        IEnumerable<System.ComponentModel.DataAnnotations.ValidationResult> IValidatableObject.Validate(ValidationContext validationContext)
        {
            ...
            if (this.Amount > (decimal)100000000000000000)
            {
                yield return new System.ComponentModel.DataAnnotations.ValidationResult("Invalid value for Amount, must be a value less than or equal to 100000000000000000.", new[] { "Amount" });
            }
