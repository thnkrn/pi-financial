...
{
    /// <summary>
    /// EndBeneficiaryIdentificationDocument
    /// </summary>
    [DataContract(Name = "EndBeneficiary_identificationDocument")]
    public partial class EndBeneficiaryIdentificationDocument : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndBeneficiaryIdentificationDocument" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EndBeneficiaryIdentificationDocument() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EndBeneficiaryIdentificationDocument" /> class.
        /// </summary>
        ...
        public EndBeneficiaryIdentificationDocument(string no = default(string), string subDistrict = default(string), string district = default(string), string province = default(string), string postalCode = default(string), string country = default(string), string floor = default(string), string building = default(string), string roomNo = default(string), string soi = default(string), string road = default(string), string moo = default(string))
        {
            // to ensure "no" is required (not null)
            if (no == null)
            {
                throw new ArgumentNullException("no is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
            this.No = no;
            // to ensure "subDistrict" is required (not null)
            if (subDistrict == null)
            {
                throw new ArgumentNullException("subDistrict is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
            this.SubDistrict = subDistrict;
            // to ensure "district" is required (not null)
            if (district == null)
            {
                throw new ArgumentNullException("district is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
            this.District = district;
            // to ensure "province" is required (not null)
            if (province == null)
            {
                throw new ArgumentNullException("province is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
            this.Province = province;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for EndBeneficiaryIdentificationDocument and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EndBeneficiaryIdentificationDocument {\n");
