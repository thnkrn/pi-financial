...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// AddressV5
    /// </summary>
    [DataContract(Name = "AddressV5")]
    public partial class AddressV5 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressV5" /> class.
        /// </summary>
        ...
        /// <param name="subdistrict">แขวง/ตำบล ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data (required).</param>
        /// <param name="district">เขต/อำเภอ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data (required).</param>
        /// <param name="province">จังหวัด ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data (required).</param>
        /// <param name="postalCode">รหัสไปรษณีย์ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data (required).</param>
        /// <param name="country">ประเทศ อ้างอิงตาม FundConnext Master Data (required).</param>
        public AddressV5(string no = default(string), string floor = default(string), string building = default(string), string roomNo = default(string), string soi = default(string), string road = default(string), string moo = default(string), string subdistrict = default(string), string district = default(string), string province = default(string), string postalCode = default(string), string country = default(string))
        {
            // to ensure "no" is required (not null)
            if (no == null)
            {
                throw new ArgumentNullException("no is a required property for AddressV5 and cannot be null");
            }
            this.No = no;
            // to ensure "subdistrict" is required (not null)
            if (subdistrict == null)
            {
                throw new ArgumentNullException("subdistrict is a required property for AddressV5 and cannot be null");
            }
            this.Subdistrict = subdistrict;
            // to ensure "district" is required (not null)
            if (district == null)
            {
                throw new ArgumentNullException("district is a required property for AddressV5 and cannot be null");
            }
            this.District = district;
            // to ensure "province" is required (not null)
            if (province == null)
            {
                throw new ArgumentNullException("province is a required property for AddressV5 and cannot be null");
            }
            this.Province = province;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for AddressV5 and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for AddressV5 and cannot be null");
            }
        ...
        /// <summary>
        /// แขวง/ตำบล ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data
        /// </summary>
        /// <value>แขวง/ตำบล ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data</value>
        [DataMember(Name = "subdistrict", IsRequired = true, EmitDefaultValue = true)]
        public string Subdistrict { get; set; }

        /// <summary>
        /// เขต/อำเภอ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data
        /// </summary>
        /// <value>เขต/อำเภอ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data</value>
        [DataMember(Name = "district", IsRequired = true, EmitDefaultValue = true)]
        public string District { get; set; }

        /// <summary>
        /// จังหวัด ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data
        /// </summary>
        /// <value>จังหวัด ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data</value>
        [DataMember(Name = "province", IsRequired = true, EmitDefaultValue = true)]
        public string Province { get; set; }

        /// <summary>
        /// รหัสไปรษณีย์ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data
        /// </summary>
        /// <value>รหัสไปรษณีย์ ถ้า country&#x3D;TH จะอ้างอิงตาม FundConnext Master Data</value>
        [DataMember(Name = "postalCode", IsRequired = true, EmitDefaultValue = true)]
        public string PostalCode { get; set; }

        /// <summary>
        /// ประเทศ อ้างอิงตาม FundConnext Master Data
        /// </summary>
        /// <value>ประเทศ อ้างอิงตาม FundConnext Master Data</value>
