...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// AccountV5Response
    /// </summary>
    [DataContract(Name = "AccountV5Response")]
    public partial class AccountV5Response : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountV5Response" /> class.
        /// </summary>
        ...
        /// <param name="redemptionBankAccounts">บัญชีรับเงินค่าขายคืน&lt;br/&gt; (เลือก default ได้แค่บัญชีเดียว).</param>
        /// <param name="subscriptionBankAccounts">บัญชีตัดค่าซื้อกองทุน&lt;br/&gt; (เลือก default ได้ 1 บัญชีเท่านั้น).</param>
        ...
        public AccountV5Response(IdentificationCardTypeEnum? identificationCardType = default(IdentificationCardTypeEnum?), string passportCountry = default(string), AccountResponseCardNumber cardNumber = default(AccountResponseCardNumber), string juristicNumber = default(string), string accountId = default(string), string icLicense = default(string), string accountOpenDate = default(string), string mailingAddressSameAsFlag = default(string), AddressV5 mailing = default(AddressV5), string mailingMethod = default(string), string investmentObjective = default(string), string investmentObjectiveOther = default(string), List<RedemptionBankAccountsResponse> redemptionBankAccounts = default(List<RedemptionBankAccountsResponse>), List<SubscriptionBankAccounts> subscriptionBankAccounts = default(List<SubscriptionBankAccounts>), string approvedDate = default(string), string approvedDateTime = default(string), bool? openOmnibusFormFlag = default(bool?), AccountStatusEnum? accountStatus = default(AccountStatusEnum?), ProcessStatusEnum? processStatus = default(ProcessStatusEnum?), List<UnitholderResponse> unitholders = default(List<UnitholderResponse>))
        {
        ...
        /// </summary>
        [DataMember(Name = "mailing", EmitDefaultValue = true)]
        public AddressV5 Mailing { get; set; }
        ...
        /// <summary>
        /// บัญชีรับเงินค่าขายคืน&lt;br/&gt; (เลือก default ได้แค่บัญชีเดียว)
        /// </summary>
        /// <value>บัญชีรับเงินค่าขายคืน&lt;br/&gt; (เลือก default ได้แค่บัญชีเดียว)</value>
        ...
        /// <summary>
        /// บัญชีตัดค่าซื้อกองทุน&lt;br/&gt; (เลือก default ได้ 1 บัญชีเท่านั้น)
        /// </summary>
        /// <value>บัญชีตัดค่าซื้อกองทุน&lt;br/&gt; (เลือก default ได้ 1 บัญชีเท่านั้น)</value>
        ...
        public List<UnitholderResponse> Unitholders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountV5Response {\n");
