...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// Unitholders
    /// </summary>
    [DataContract(Name = "Unitholders")]
    public partial class Unitholders : IValidatableObject
    {
        /// <summary>
        /// Defines Status
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Unitholders" /> class.
        /// </summary>
        ...
        /// <param name="currency">สกุลเงินของบัญชีธนาคาร เช่น​ THB, USD (SA จะต้องมีการเปิด Flag &#39;Used Foreign Currency Fund&#39; ก่อน) ** มีค่าเสมอสำหรับ Individual Account.</param>
        public Unitholders(string unitholderId = default(string), string amcCode = default(string), string accountId = default(string), List<UnitholderSubscriptionBankAccounts> subscriptionBankAccounts = default(List<UnitholderSubscriptionBankAccounts>), List<UnitholderRedemptionBankAccountsWithoutDDR> redemptionBankAccounts = default(List<UnitholderRedemptionBankAccountsWithoutDDR>), bool approved = default(bool), StatusEnum? status = default(StatusEnum?), string currency = default(string))
        {
        ...
        public List<UnitholderRedemptionBankAccountsWithoutDDR> RedemptionBankAccounts { get; set; }
        ...
        /// <summary>
        /// สกุลเงินของบัญชีธนาคาร เช่น​ THB, USD (SA จะต้องมีการเปิด Flag &#39;Used Foreign Currency Fund&#39; ก่อน) ** มีค่าเสมอสำหรับ Individual Account
        /// </summary>
        /// <value>สกุลเงินของบัญชีธนาคาร เช่น​ THB, USD (SA จะต้องมีการเปิด Flag &#39;Used Foreign Currency Fund&#39; ก่อน) ** มีค่าเสมอสำหรับ Individual Account</value>
