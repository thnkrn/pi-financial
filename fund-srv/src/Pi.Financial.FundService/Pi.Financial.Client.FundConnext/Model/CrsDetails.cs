...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// CrsDetails
    /// </summary>
    [DataContract(Name = "CrsDetails")]
    public partial class CrsDetails : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CrsDetails" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CrsDetails() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CrsDetails" /> class.
        /// </summary>
        ...
        public CrsDetails(string countryOfTaxResidence = default(string), string tin = default(string), ReasonEnum? reason = default(ReasonEnum?), string reasonDesc = default(string))
        {
            // to ensure "countryOfTaxResidence" is required (not null)
            if (countryOfTaxResidence == null)
            {
                throw new ArgumentNullException("countryOfTaxResidence is a required property for CrsDetails and cannot be null");
            }
