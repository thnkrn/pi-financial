...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    /// AddressForProfileV5
    /// </summary>
    [DataContract(Name = "AddressForProfileV5")]
    public partial class AddressForProfileV5 : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressForProfileV5" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AddressForProfileV5() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AddressForProfileV5" /> class.
        /// </summary>
        ...
        public AddressForProfileV5(string no = default(string), string floor = default(string), string building = default(string), string roomNo = default(string), string soi = default(string), string road = default(string), string moo = default(string), string subdistrict = default(string), string district = default(string), string province = default(string), string postalCode = default(string), string country = default(string))
        {
            // to ensure "no" is required (not null)
            if (no == null)
            {
                throw new ArgumentNullException("no is a required property for AddressForProfileV5 and cannot be null");
            }
            this.No = no;
            // to ensure "subdistrict" is required (not null)
            if (subdistrict == null)
            {
                throw new ArgumentNullException("subdistrict is a required property for AddressForProfileV5 and cannot be null");
            }
            this.Subdistrict = subdistrict;
            // to ensure "district" is required (not null)
            if (district == null)
            {
                throw new ArgumentNullException("district is a required property for AddressForProfileV5 and cannot be null");
            }
            this.District = district;
            // to ensure "province" is required (not null)
            if (province == null)
            {
                throw new ArgumentNullException("province is a required property for AddressForProfileV5 and cannot be null");
            }
            this.Province = province;
            // to ensure "postalCode" is required (not null)
            if (postalCode == null)
            {
                throw new ArgumentNullException("postalCode is a required property for AddressForProfileV5 and cannot be null");
            }
            this.PostalCode = postalCode;
            // to ensure "country" is required (not null)
            if (country == null)
            {
                throw new ArgumentNullException("country is a required property for AddressForProfileV5 and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AddressForProfileV5 {\n");
