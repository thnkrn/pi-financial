...
{
    /// <summary>
    /// JuristicInvestorV5ResponseJuristicDirectorsInner
    /// </summary>
    [DataContract(Name = "JuristicInvestorV5Response_juristicDirectors_inner")]
    public partial class JuristicInvestorV5ResponseJuristicDirectorsInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseJuristicDirectorsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JuristicInvestorV5ResponseJuristicDirectorsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseJuristicDirectorsInner" /> class.
        /// </summary>
        ...
        public JuristicInvestorV5ResponseJuristicDirectorsInner(IdentificationCardTypeEnum identificationCardType = default(IdentificationCardTypeEnum), string passportCountry = default(string), IndividualInvestorV5ResponseCardNumber cardNumber = default(IndividualInvestorV5ResponseCardNumber), string nationality = default(string), string thFirstName = default(string), string thLastName = default(string), bool isAuthorized = default(bool), bool isChiefExecutive = default(bool))
        {
            this.IdentificationCardType = identificationCardType;
            // to ensure "cardNumber" is required (not null)
            if (cardNumber == null)
            {
                throw new ArgumentNullException("cardNumber is a required property for JuristicInvestorV5ResponseJuristicDirectorsInner and cannot be null");
            }
            this.CardNumber = cardNumber;
            // to ensure "thFirstName" is required (not null)
            if (thFirstName == null)
            {
                throw new ArgumentNullException("thFirstName is a required property for JuristicInvestorV5ResponseJuristicDirectorsInner and cannot be null");
            }
            this.ThFirstName = thFirstName;
            // to ensure "thLastName" is required (not null)
            if (thLastName == null)
            {
                throw new ArgumentNullException("thLastName is a required property for JuristicInvestorV5ResponseJuristicDirectorsInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JuristicInvestorV5ResponseJuristicDirectorsInner {\n");
