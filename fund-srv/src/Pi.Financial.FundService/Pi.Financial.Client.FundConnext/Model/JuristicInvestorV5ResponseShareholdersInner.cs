...
{
    /// <summary>
    /// JuristicInvestorV5ResponseShareholdersInner
    /// </summary>
    [DataContract(Name = "JuristicInvestorV5Response_shareholders_inner")]
    public partial class JuristicInvestorV5ResponseShareholdersInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseShareholdersInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JuristicInvestorV5ResponseShareholdersInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseShareholdersInner" /> class.
        /// </summary>
        ...
        public JuristicInvestorV5ResponseShareholdersInner(TypeEnum type = default(TypeEnum), string nationality = default(string), IdentificationCardTypeEnum? identificationCardType = default(IdentificationCardTypeEnum?), string passportCountry = default(string), string cardNumber = default(string), string cardExpiryDate = default(string), string firstName = default(string), string lastName = default(string), string juristicNumber = default(string), string registeredCountryCode = default(string), List<ShareholdersShareholdersInner> shareholders = default(List<ShareholdersShareholdersInner>))
        {
            this.Type = type;
            // to ensure "firstName" is required (not null)
            if (firstName == null)
            {
                throw new ArgumentNullException("firstName is a required property for JuristicInvestorV5ResponseShareholdersInner and cannot be null");
            }
        ...
        public List<ShareholdersShareholdersInner> Shareholders { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JuristicInvestorV5ResponseShareholdersInner {\n");
