...
{
    /// <summary>
    /// JuristicInvestorV5ResponseAuthorizedSignatoriesInner
    /// </summary>
    [DataContract(Name = "JuristicInvestorV5Response_authorizedSignatories_inner")]
    public partial class JuristicInvestorV5ResponseAuthorizedSignatoriesInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// การกำหนดที่อยู่ที่ปัจจุบันให้เหมือน ที่อยู่ตามประเภทหลักฐาน IdDocument &#x3D; เหมือนที่อยู่ตามประเภทหลักฐาน 
        /// </summary>
        /// <value>การกำหนดที่อยู่ที่ปัจจุบันให้เหมือน ที่อยู่ตามประเภทหลักฐาน IdDocument &#x3D; เหมือนที่อยู่ตามประเภทหลักฐาน </value>
        [JsonConverter(typeof(StringEnumConverter))]
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseAuthorizedSignatoriesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JuristicInvestorV5ResponseAuthorizedSignatoriesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseAuthorizedSignatoriesInner" /> class.
        /// </summary>
        ...
        /// <param name="dateOfBirth">วันเกิด เป็น ค.ศ. (YYYYMMDD)  (required).</param>
        /// <param name="identificationDocument">identificationDocument (required).</param>
        /// <param name="currentAddressSameAsFlag">การกำหนดที่อยู่ที่ปัจจุบันให้เหมือน ที่อยู่ตามประเภทหลักฐาน IdDocument &#x3D; เหมือนที่อยู่ตามประเภทหลักฐาน .</param>
        ...
        public JuristicInvestorV5ResponseAuthorizedSignatoriesInner(IdentificationCardTypeEnum identificationCardType = default(IdentificationCardTypeEnum), string passportCountry = default(string), string cardNumber = default(string), string cardExpiryDate = default(string), string thFirstName = default(string), string thLastName = default(string), string dateOfBirth = default(string), AuthorizedSignatoriesIdentificationDocument identificationDocument = default(AuthorizedSignatoriesIdentificationDocument), CurrentAddressSameAsFlagEnum? currentAddressSameAsFlag = default(CurrentAddressSameAsFlagEnum?), AuthorizedSignatoriesCurrent current = default(AuthorizedSignatoriesCurrent), bool? politicalRelatedPerson = default(bool?), string politicalRelatedPersonPosition = default(string))
        {
            this.IdentificationCardType = identificationCardType;
            // to ensure "cardNumber" is required (not null)
            if (cardNumber == null)
            {
                throw new ArgumentNullException("cardNumber is a required property for JuristicInvestorV5ResponseAuthorizedSignatoriesInner and cannot be null");
            }
            this.CardNumber = cardNumber;
            // to ensure "thFirstName" is required (not null)
            if (thFirstName == null)
            {
                throw new ArgumentNullException("thFirstName is a required property for JuristicInvestorV5ResponseAuthorizedSignatoriesInner and cannot be null");
            }
            this.ThFirstName = thFirstName;
            // to ensure "thLastName" is required (not null)
            if (thLastName == null)
            {
                throw new ArgumentNullException("thLastName is a required property for JuristicInvestorV5ResponseAuthorizedSignatoriesInner and cannot be null");
            }
            this.ThLastName = thLastName;
            // to ensure "dateOfBirth" is required (not null)
            if (dateOfBirth == null)
            {
                throw new ArgumentNullException("dateOfBirth is a required property for JuristicInvestorV5ResponseAuthorizedSignatoriesInner and cannot be null");
            }
            this.DateOfBirth = dateOfBirth;
            // to ensure "identificationDocument" is required (not null)
            if (identificationDocument == null)
            {
                throw new ArgumentNullException("identificationDocument is a required property for JuristicInvestorV5ResponseAuthorizedSignatoriesInner and cannot be null");
            }
        ...
        public AuthorizedSignatoriesIdentificationDocument IdentificationDocument { get; set; }

        /// <summary>
        /// Gets or Sets Current
        /// </summary>
        [DataMember(Name = "current", EmitDefaultValue = false)]
        public AuthorizedSignatoriesCurrent Current { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JuristicInvestorV5ResponseAuthorizedSignatoriesInner {\n");
