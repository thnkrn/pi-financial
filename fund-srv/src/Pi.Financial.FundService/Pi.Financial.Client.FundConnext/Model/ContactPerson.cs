...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    public partial class ContactPerson : IValidatableObject
    {
        ...
        public ContactPerson(string firstName = default(string), string lastName = default(string), string position = default(string), string telephone = default(string), string fax = default(string), string email = default(string))
        {
            ...
            if (telephone == null)
            {
                throw new ArgumentNullException("telephone is a required property for ContactPerson and cannot be null");
            }
