...
namespace Pi.Financial.Client.FundConnext.Model
{
    ...
    public partial class Address : IValidatableObject
    {
        ...
        public Address(string no = default(string), string subDistrict = default(string), string district = default(string), string province = default(string), string postalCode = default(string), string country = default(string), string floor = default(string), string building = default(string), string roomNo = default(string), string soi = default(string), string road = default(string), string moo = default(string))
        {
            // to ensure "no" is required (not null)
            if (no == null)
            {
                throw new ArgumentNullException("no is a required property for Address and cannot be null");
            }
            this.No = no;
            // to ensure "subDistrict" is required (not null)
            if (subDistrict == null)
            {
                throw new ArgumentNullException("subDistrict is a required property for Address and cannot be null");
            }
            this.SubDistrict = subDistrict;
            // to ensure "district" is required (not null)
            if (district == null)
            {
                throw new ArgumentNullException("district is a required property for Address and cannot be null");
            }
            this.District = district;
            // to ensure "province" is required (not null)
            if (province == null)
            {
                throw new ArgumentNullException("province is a required property for Address and cannot be null");
            }
