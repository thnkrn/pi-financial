...
{
    /// <summary>
    /// JuristicInvestorV5ResponseCrsDetailsInner
    /// </summary>
    [DataContract(Name = "JuristicInvestorV5Response_crsDetails_inner")]
    public partial class JuristicInvestorV5ResponseCrsDetailsInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseCrsDetailsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected JuristicInvestorV5ResponseCrsDetailsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="JuristicInvestorV5ResponseCrsDetailsInner" /> class.
        /// </summary>
        ...
        public JuristicInvestorV5ResponseCrsDetailsInner(string countryOfTaxResidence = default(string), string tin = default(string), ReasonEnum? reason = default(ReasonEnum?), string reasonDesc = default(string))
        {
            // to ensure "countryOfTaxResidence" is required (not null)
            if (countryOfTaxResidence == null)
            {
                throw new ArgumentNullException("countryOfTaxResidence is a required property for JuristicInvestorV5ResponseCrsDetailsInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class JuristicInvestorV5ResponseCrsDetailsInner {\n");
