...
{
    /// <summary>
    /// CustomerAccountCreateRequestV6
    /// </summary>
    [DataContract(Name = "CustomerAccountCreateRequestV6")]
    public partial class CustomerAccountCreateRequestV6 : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAccountCreateRequestV6" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CustomerAccountCreateRequestV6() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerAccountCreateRequestV6" /> class.
        /// </summary>
        ...
        /// <param name="cddDate">วันที่ทำ CDD เป็น ค.ศ. (YYYYMMDD) (required).</param>
        ...
        public CustomerAccountCreateRequestV6(IdentificationCardTypeEnum identificationCardType = default(IdentificationCardTypeEnum), string passportCountry = default(string), string cardNumber = default(string), string cardExpiryDate = default(string), AccompanyingDocumentEnum? accompanyingDocument = default(AccompanyingDocumentEnum?), TitleEnum title = default(TitleEnum), string titleOther = default(string), string enFirstName = default(string), string enLastName = default(string), string thFirstName = default(string), string thLastName = default(string), string birthDate = default(string), string nationality = default(string), string mobileNumber = default(string), string email = default(string), string phone = default(string), string fax = default(string), MaritalStatusEnum maritalStatus = default(MaritalStatusEnum), Spouse spouse = default(Spouse), OccupationId occupationId = default(OccupationId), string occupationOther = default(string), BusinessTypeId? businessTypeId = default(BusinessTypeId?), string businessTypeOther = default(string), MonthlyIncomeLevel monthlyIncomeLevel = default(MonthlyIncomeLevel), decimal? assetValue = default(decimal?), string incomeSource = default(string), string incomeSourceOther = default(string), AddressForProfileV5 identificationDocument = default(AddressForProfileV5), CurrentAddressSameAsFlagEnum? currentAddressSameAsFlag = default(CurrentAddressSameAsFlagEnum?), AddressForProfileV5 current = default(AddressForProfileV5), string companyName = default(string), AddressForProfileV5 work = default(AddressForProfileV5), string workPosition = default(string), bool? relatedPoliticalPerson = default(bool?), string politicalRelatedPersonPosition = default(string), bool canAcceptFxRisk = default(bool), bool canAcceptDerivativeInvestment = default(bool), SuitabilityRiskLevelEnum suitabilityRiskLevel = default(SuitabilityRiskLevelEnum), string suitabilityEvaluationDate = default(string), bool fatca = default(bool), string fatcaDeclarationDate = default(string), string crsPlaceOfBirthCountry = default(string), string crsPlaceOfBirthCity = default(string), bool? crsTaxResidenceInCountriesOtherThanTheUS = default(bool?), List<CustomerAccountCreateRequestV5CrsDetailsInner> crsDetails = default(List<CustomerAccountCreateRequestV5CrsDetailsInner>), string crsDeclarationDate = default(string), CddScoreEnum? cddScore = default(CddScoreEnum?), string cddDate = default(string), string referralPerson = default(string), string applicationDate = default(string), string incomeSourceCountry = default(string), string acceptedBy = default(string), OpenFundConnextFormFlagEnum openFundConnextFormFlag = default(OpenFundConnextFormFlagEnum), bool approved = default(bool), bool? vulnerableFlag = default(bool?), string vulnerableDetail = default(string), bool? ndidFlag = default(bool?), string ndidRequestId = default(string), OpenChannelEnum openChannel = default(OpenChannelEnum), CustomerAccountCreateRequestV5SuitabilityForm suitabilityForm = default(CustomerAccountCreateRequestV5SuitabilityForm), InvestorClassEnum? investorClass = default(InvestorClassEnum?), bool? knowledgeAssessmentResult = default(bool?), IndividualInvestorV5ResponseKnowledgeAssessmentForm knowledgeAssessmentForm = default(IndividualInvestorV5ResponseKnowledgeAssessmentForm), string identityVerificationDateTime = default(string), string dopaVerificationDateTime = default(string))
        {
            ...
            if (enFirstName == null)
            {
                throw new ArgumentNullException("enFirstName is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.EnFirstName = enFirstName;
            // to ensure "enLastName" is required (not null)
            if (enLastName == null)
            {
                throw new ArgumentNullException("enLastName is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.EnLastName = enLastName;
            // to ensure "thFirstName" is required (not null)
            if (thFirstName == null)
            {
                throw new ArgumentNullException("thFirstName is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.ThFirstName = thFirstName;
            // to ensure "thLastName" is required (not null)
            if (thLastName == null)
            {
                throw new ArgumentNullException("thLastName is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.ThLastName = thLastName;
            // to ensure "birthDate" is required (not null)
            if (birthDate == null)
            {
                throw new ArgumentNullException("birthDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.BirthDate = birthDate;
            // to ensure "nationality" is required (not null)
            if (nationality == null)
            {
                throw new ArgumentNullException("nationality is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.Nationality = nationality;
            // to ensure "mobileNumber" is required (not null)
            if (mobileNumber == null)
            {
                throw new ArgumentNullException("mobileNumber is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("incomeSource is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.IncomeSource = incomeSource;
            // to ensure "identificationDocument" is required (not null)
            if (identificationDocument == null)
            {
                throw new ArgumentNullException("identificationDocument is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("suitabilityEvaluationDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("fatcaDeclarationDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("crsPlaceOfBirthCountry is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("crsPlaceOfBirthCity is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            {
                throw new ArgumentNullException("crsTaxResidenceInCountriesOtherThanTheUS is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            ...
            if (crsDetails == null)
            {
                throw new ArgumentNullException("crsDetails is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.CrsDetails = crsDetails;
            // to ensure "crsDeclarationDate" is required (not null)
            if (crsDeclarationDate == null)
            {
                throw new ArgumentNullException("crsDeclarationDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.CrsDeclarationDate = crsDeclarationDate;
            // to ensure "cddDate" is required (not null)
            if (cddDate == null)
            {
                throw new ArgumentNullException("cddDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.CddDate = cddDate;
            // to ensure "applicationDate" is required (not null)
            if (applicationDate == null)
            {
                throw new ArgumentNullException("applicationDate is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.ApplicationDate = applicationDate;
            // to ensure "incomeSourceCountry" is required (not null)
            if (incomeSourceCountry == null)
            {
                throw new ArgumentNullException("incomeSourceCountry is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.IncomeSourceCountry = incomeSourceCountry;
            this.OpenFundConnextFormFlag = openFundConnextFormFlag;
            this.Approved = approved;
            this.OpenChannel = openChannel;
            // to ensure "identityVerificationDateTime" is required (not null)
            if (identityVerificationDateTime == null)
            {
                throw new ArgumentNullException("identityVerificationDateTime is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
            this.IdentityVerificationDateTime = identityVerificationDateTime;
            // to ensure "dopaVerificationDateTime" is required (not null)
            if (dopaVerificationDateTime == null)
            {
                throw new ArgumentNullException("dopaVerificationDateTime is a required property for CustomerAccountCreateRequestV6 and cannot be null");
            }
        ...
        [DataMember(Name = "cddDate", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// <summary>
        /// เป็น ค.ศ.+ชั่วโมงนาทีวินาที (YYYYMMDDHHmmss)
        /// </summary>
        /// <value>เป็น ค.ศ.+ชั่วโมงนาทีวินาที (YYYYMMDDHHmmss)</value>
        [DataMember(Name = "identityVerificationDateTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        /// </summary>
        /// <value>เป็น ค.ศ.+ชั่วโมงนาทีวินาที (YYYYMMDDHHmmss)</value>
        [DataMember(Name = "dopaVerificationDateTime", IsRequired = true, EmitDefaultValue = true)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CustomerAccountCreateRequestV6 {\n");
