...
{
    /// <summary>
    /// IndividualInvestorV5ResponseCrsDetailsInner
    /// </summary>
    [DataContract(Name = "IndividualInvestorV5Response_crsDetails_inner")]
    public partial class IndividualInvestorV5ResponseCrsDetailsInner : IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualInvestorV5ResponseCrsDetailsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IndividualInvestorV5ResponseCrsDetailsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IndividualInvestorV5ResponseCrsDetailsInner" /> class.
        /// </summary>
        ...
        public IndividualInvestorV5ResponseCrsDetailsInner(string countryOfTaxResidence = default(string), string tin = default(string), ReasonEnum? reason = default(ReasonEnum?), string reasonDesc = default(string))
        {
            // to ensure "countryOfTaxResidence" is required (not null)
            if (countryOfTaxResidence == null)
            {
                throw new ArgumentNullException("countryOfTaxResidence is a required property for IndividualInvestorV5ResponseCrsDetailsInner and cannot be null");
            }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IndividualInvestorV5ResponseCrsDetailsInner {\n");
