...
namespace Pi.Financial.FundService.Migrations.Migrations
{
    ...
    [Migration("20240626064807_CreateCustomerDataSyncHistoryTable")]
    partial class CreateCustomerDataSyncHistoryTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pi.Financial.FundService.Domain.AggregatesModel.CustomerDataAggregate.CustomerDataSyncHistory", b =>
                {
                    b.Property<Guid>("CorrelationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.Property<bool?>("AccountUpdateSuccess")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("account_update_success");
                    ...
                    b.Property<bool?>("ProfileUpdateSuccess")
                        .HasColumnType("tinyint(1)")
                        .HasColumnName("profile_update_success");
                    ...
                    b.HasKey("CorrelationId")
                        .HasName("pk_customer_data_sync_histories");

                    b.ToTable("customer_data_sync_histories", (string)null);
                });
            ...
            modelBuilder.Entity("Pi.Financial.FundService.Domain.AggregatesModel.TradingAggregate.FundOrderState", b =>
                {
                    ...
                    b.HasIndex("BrokerOrderId", "OrderType")
                        .IsUnique()
                        .HasDatabaseName("ix_fund_order_state_broker_order_id_order_type");

                    b.HasIndex("OrderNo", "OrderType")
                        .IsUnique()
                        .HasDatabaseName("ix_fund_order_state_order_no_order_type");
