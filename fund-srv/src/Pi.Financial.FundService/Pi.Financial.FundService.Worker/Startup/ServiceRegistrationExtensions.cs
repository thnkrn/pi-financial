...
using IUserDocumentApi = Pi.Client.UserService.Api.IDocumentApi;
using UserDocumentApi = Pi.Client.UserService.Api.DocumentApi;
    ...
    public static class ServiceRegistrationExtensions
    {
        public static IServiceCollection AddServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddOptions<OnboardServiceOptions>()
                ...
                .ValidateDataAnnotations()
                .ValidateOnStart();
            services.AddOptions<FundTradingOptions>()
                .Bind(configuration.GetSection(FundTradingOptions.Options))
                .ValidateDataAnnotations()
                .ValidateOnStart();
            ...
            services.AddScoped<IUserDocumentApi>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<UserServiceOptions>>();
                return new UserDocumentApi(
                    sp.GetRequiredService<IHttpClientFactory>().CreateClient("User"), options.Value.Host);
            });
