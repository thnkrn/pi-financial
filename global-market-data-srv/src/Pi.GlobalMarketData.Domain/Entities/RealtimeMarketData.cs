...
{
    [Key] [Column("date_time", Order = 0)] public DateTimeOffset DateTime { get; set; }

    [Key] [Column("symbol", Order = 1)] public string? Symbol { get; set; }

    [Key] [Column("venue", Order = 2)] public string? Venue { get; set; }
