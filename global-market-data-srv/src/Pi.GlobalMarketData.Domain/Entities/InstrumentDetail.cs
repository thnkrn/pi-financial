...
public class InstrumentDetail
{
    ...
    [BsonElement("expense_ratio_percentage")] public string? ExpenseRatioPercentage { get; set; }
    ...
    [BsonElement("implied_volatility_percent")] public string? ImpliedVolatilityPercent { get; set; }

    [BsonElement("description")] public string? Description { get; set; }

    [BsonElement("website")] public string? Website { get; set; }

    [BsonElement("decimals_in_price")] public int? DecimalsInPrice { get; set; }

    [BsonElement("decimal_in_strike_price")] public int? DecimalInStrikePrice { get; set; }

    [BsonElement("decimal_in_contract_size_pqf")] public int? DecimalInContractSizePQF { get; set; }
