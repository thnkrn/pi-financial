...
public class PublicTrade
{
    ...
    [BsonElement("public_trade_id")] public int PublicTradeId { get; set; }

    [BsonElement("instrument_id")] public int InstrumentId { get; set; }

    [BsonElement("price")] public string? Price { get; set; }

    [BsonElement("quantity")] public string? Quantity { get; set; }

    [BsonElement("trade_time")] public string? TradeTime { get; set; }
