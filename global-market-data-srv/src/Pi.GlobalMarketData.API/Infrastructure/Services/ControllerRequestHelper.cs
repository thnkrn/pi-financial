...
namespace Pi.GlobalMarketData.API.Infrastructure.Services;
        ...
        where TBusResponse : class
    {
        try
        {
            if (!validateModel(modelState))
            {
                ...
                throw ExceptionHelper.BadRequestException(ApiConstants.InvalidRequestError);
            }
        ...
        catch (UnauthorizedAccessException ex)
        {
            ...
            throw ExceptionHelper.UnauthorizedErrorException(ApiConstants.UnauthorizedAccessError, ex);
        }
                                   ...
                                   && ex is not UnauthorizedErrorException)
        {
            ...
            throw ExceptionHelper.InternalServerErrorException(ApiConstants.InternalServerError, ex);
        }
    }
        ...
        where TResponse : class
    {
        try
        {
            ...
            if (!busResponse.IsValid || busResponse.Result == null)
            {
                ...
                throw ExceptionHelper.NotFoundException(ApiConstants.NoResultError);
            }
