...
namespace Pi.GlobalMarketData.Application.Tests.Services.MarketDerivativeInformation;
...
public class MarketDerivativeInformationServiceTests
{
    ...
    public void GetResult_ShouldReturnCorrectResponse_WhenInstrumentHasAllFields()
    {
        ...
        // Act
        var result = MarketDerivativeInformationService.GetResult(instrument);
        ...
        Assert.Equal(instrument.TradingUnit, result.Response.TradingUnit);
