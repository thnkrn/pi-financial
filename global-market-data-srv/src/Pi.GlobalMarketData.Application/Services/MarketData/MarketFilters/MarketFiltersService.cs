...
namespace Pi.GlobalMarketData.Application.Services.MarketData.MarketFilters
{
    public static class MarketFiltersService
    {
        public static MarketFiltersResponse GetResult(List<CuratedFilter> curatedFilters)
        {
            ...
            var groupedFilters = curatedFilters
                .GroupBy(cf => new { cf.FilterCategory, cf.FilterType, cf.CategoryPriority })
                .ToList();
            ...
            foreach (var group in groupedFilters)
            {
                ...
                {
                    filterList.Add(new Domain.Models.Response.Filter
                    {
