...
public static class MorningStarEndpoints
{
    ...
    private const string stockQuery =
        "exchangeId={1}&identifierType={2}&identifier={3}&stockStatus={4}&responseType={5}&Token={0}";
    ...
    public const string getFullStockExchangeSecurityList =
        globalMasterListsService + "GetFullStockExchangeSecurityList?" + stockQuery;
