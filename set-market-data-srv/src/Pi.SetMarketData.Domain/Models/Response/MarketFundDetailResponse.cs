...
namespace Pi.SetMarketData.Domain.Models.Response;
    ...
    {
        [JsonPropertyName("inceptionData")]
        public string? InceptionData { get; set; }
        ...
        [JsonPropertyName("fundPolicy")]
        public string? FundPolicy { get; set; }

        [JsonPropertyName("fxRiskPolicy")]
        ...
        public FundPerformance? FundPerformance { get; set; }

        [JsonPropertyName("minBuyAmount")]
        public string? MinBuyAmount { get; set; }

        [JsonPropertyName("minSellAmount")]
        public string? MinSellAmount { get; set; }

        [JsonPropertyName("minSellUnit")]
        public string? MinSellUnit { get; set; }

        [JsonPropertyName("minHoldAmount")]
        public string? MinHoldAmount { get; set; }

        [JsonPropertyName("minHoldUnit")]
        public string? MinHoldUnit { get; set; }

        [JsonPropertyName("tradeStartHrs")]
        public string? TradeStartHrs { get; set; }

        [JsonPropertyName("tradeEndHrs")]
        public string? TradeEndHrs { get; set; }

        [JsonPropertyName("factSheetURL")]
        public string? FactSheetUrl { get; set; }

        [JsonPropertyName("investmentList")]
        public List<object>? InvestmentList { get; set; }

        [JsonPropertyName("allowSwitchOut")]
    ...
    public class MarketFundDetailResponse
    {
        ...
        public FundDetailResponse? Response { get; set; }
    }