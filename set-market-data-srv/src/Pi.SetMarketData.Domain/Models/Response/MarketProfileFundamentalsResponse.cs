...
namespace Pi.SetMarketData.Domain.Models.Response;
    ...
    public class ProfileFundamentalsResponse
    {
        ...
        [JsonPropertyName("shareFreeFloat")]
        ...
        [JsonPropertyName("underlyingVenue")]
        ...
        [JsonPropertyName("daysToLastTrade")]
        public string? DaysToLastTrade { get; set; }

        [JsonPropertyName("maturityDate")]
        public string? MaturityDate { get; set; }

        [JsonPropertyName("issuerSeries")]
        ...
        [JsonPropertyName("lastNavPerShare")]
        public string? LastNavPerShare { get; set; }

        [JsonPropertyName("objective")]
        public string? Objective { get; set; }

        [JsonPropertyName("assetClassFocus")]
        ...
        [JsonPropertyName("theoreticalPrice")]
    ...
    public class MarketProfileFundamentalsResponse
    {
        ...
        public ProfileFundamentalsResponse? Response { get; set; }
    }