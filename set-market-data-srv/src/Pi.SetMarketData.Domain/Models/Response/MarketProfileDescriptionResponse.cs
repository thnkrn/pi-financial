...
public class ProfileDescriptionResponse
{
    ...
    [JsonPropertyName("websiteLinkName")]
    public string? WebsiteLinkName { get; set; }

    [JsonPropertyName("amcCode")]
    public string? AmcCode { get; set; }

    [JsonPropertyName("amcLogo")]
    public string? AmcLogo { get; set; }

    [JsonPropertyName("amcFriendlyName")]
    public string? AmcFriendlyName { get; set; }
}
...
public class MarketProfileDescriptionResponse
{
    ...
    public ProfileDescriptionResponse? Response { get; set; }
}