...
namespace Pi.SetMarketData.Domain.Entities
{
    public class PriceInfo
    {
        ...
        [BsonElement("auction_price")]
        public string? AuctionPrice { get; set; }

        [BsonElement("auction_volume")]
