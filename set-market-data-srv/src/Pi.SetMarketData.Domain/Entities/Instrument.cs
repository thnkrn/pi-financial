...
namespace Pi.SetMarketData.Domain.Entities
{
    public class Instrument
    {
        ...
        [BsonElement("underlying_order_book_id")]
        public int? UnderlyingOrderBookID { get; set; }
        ...
        [BsonElement("security_type")]
        public string? SecurityType { get; set; }

        [BsonElement("exchange_timezone")]
        public string? ExchangeTimezone { get; set; }

        [BsonElement("minimum_order_size")]
