...
namespace Pi.SetMarketData.Domain.Entities
{
    public class InstrumentDetail
    {
        ...
        [BsonElement("instrument_detail_id")]
        ...
        [BsonElement("underlying_symbol")]
        public string? UnderlyingSymbol { get; set; }

        [BsonElement("is_clickable")]
        public bool IsClickable { get; set; }

        [BsonElement("underlying_venue")]
        ...
        [BsonElement("strike_price")]
        public string? StrikePrice { get; set; }

        [BsonElement("theoretical_price")]
        ...
        [BsonElement("decimals_in_price")]
        public int DecimalsInPrice { get; set; }

        [BsonElement("decimal_in_strike_price")]
        public int DecimalInStrikePrice { get; set; }

        [BsonElement("decimal_in_contract_size_pqf")]
