...
public static class ConfigurationKeys
{
    ...
    public const string KafkaFailedTopic = "KAFKA:FAILED_TOPIC";
    ...
    public const string SqlServerConnection = "CONNECTION_STRING:SQL_SERVER";
    ...
    public const string SiriusBaseUrl = "SIRIUS:BASE_URL";

    public const string CronjobSchedule = "CRONJOB:SCHEDULE";

    public const string InitialMarginMultiplier = "INITIAL_MARGIN_MULTIPLIER";
    ...
    public const string IndicatorMigrationBatchSize = "INDICATOR_MIGRATION_BATCH_SIZE";
