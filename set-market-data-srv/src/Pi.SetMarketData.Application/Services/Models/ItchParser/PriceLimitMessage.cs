...
public class PriceLimitMessage : ItchMessage
{
    ...
    public Price32 UpperLimit { get; private set; }
    public Price32 LowerLimit { get; private set; }
    ...
    public static PriceLimitMessage Parse(byte[] bytes)
    {
        ...
        using (var reader = new ItchMessageByteReader(new Memory<byte>(bytes)))
        {
            ...
            Price32 upperLimit = reader.ReadPrice32();
            Price32 lowerLimit = reader.ReadPrice32();
    ...
    {
        if (lowerLimit == -2147483648)
        {
            return new Price32(1) { NumberOfDecimals = 2 };
        }
