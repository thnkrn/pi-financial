...
namespace Pi.SetMarketData.Application.Services.MarketData.MarketIndicator;
...
public static class MarketIndicatorService
{
    ...
    )
    {
        ...
        int firstCandleTimeEpoch = (int)DataManipulation.ToUnixTimestamp(firstCandleTime);
        ...
        if (candleList.Count > 0)
        {
            foreach (var candle in candleList)
            {
                ...
                {
                    adjustedDate = adjustedDate.AddHours(7);
        ...
        return new MarketIndicatorResponse
        {
            ...
            Response = new IndicatorResponse
            {
                ...
                FirstCandleTime = firstCandleTimeEpoch
            }
        };
    }
}
