...
namespace Pi.SetMarketData.Infrastructure.Interfaces.TimescaleEf;
    ...
    where TEntity : class
{
    ...
    Task UpsertAsync(TEntity entity, string tableName, params string[] conflictKeys);
    Task BatchUpsertAsync(IEnumerable<TEntity> entity, string tableName, params string[] conflictKeys);
    ...
    Task UpsertBatchTechnicalIndicators(string timeframe, IEnumerable<TechnicalIndicators> technicalIndicators);
