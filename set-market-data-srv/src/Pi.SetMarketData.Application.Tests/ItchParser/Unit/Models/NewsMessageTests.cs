...
namespace Pi.SetMarketData.Application.Tests.ItchParser.Unit.Models
{
    ...
    {
        private readonly ItchParserService itchParser = new ItchParserService();
        ...
        )
        {
            ...
            MockMessageCreator.AddTimestamp(ref messageBuilder, publishDate.ToString()); // Publish Date
            ...
            MockMessageCreator.AddDate(ref messageBuilder, dateAsOf.ToString()); // Date As Of
            ...
            {
                MockMessageCreator.AddAlpha(ref messageBuilder, templateCode, 2); // Template Code
            }
        ...
        [Fact]
        public void NewsMessage_Constructor_SetsInputCorrectly()
        {
            // Arrange
            ...
            // Act
            NewsMessage? output = itchParser.Parse(input) as NewsMessage;
            ...
            Assert.Equal(new Timestamp(publishDate), output.PublishDate);
        ...
        [Fact]
        public void NewsMessage_Constructor_SetsInputCorrectlyWithArrayMoreThanOne()
        {
            // Arrange
        ...
        [Fact]
        public void NewsMessage_Constructor_SetsInputWithIncorrectFormat()
        {
            // Arrange
