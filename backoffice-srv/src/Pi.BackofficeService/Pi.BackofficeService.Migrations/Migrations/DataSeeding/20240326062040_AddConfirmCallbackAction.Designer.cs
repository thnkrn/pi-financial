...
namespace Pi.BackofficeService.Migrations.Migrations.DataSeeding
{
    ...
    [Migration("20240326062040_AddConfirmCallbackAction")]
    partial class AddConfirmCallbackAction
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Pi.BackofficeService.Domain.AggregateModels.ResponseCodeAggregate.ResponseCode", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            IsFilterable = true,
                            Machine = "Deposit",
                            State = "UpBackFailedAwaitingActionSba",
                            Suggestion = "Check Customer Trading Account Balance, before Manual Allocate"
                        },
                        new
                        {
                            ...
                            IsFilterable = true,
                            Machine = "Deposit",
                            State = "UpBackFailedAwaitingActionSetTrade",
                        ...
                        new
                        {
                            ...
                            Description = "Waiting to receiving freewill ats response",
                            IsFilterable = true,
                            Machine = "Deposit",
                            State = "WaitingForAtsGatewayConfirmation",
                            Suggestion = "Check freewill report, Check Customer Trading Account balance , before deposit sba ats"
                        });
                });
