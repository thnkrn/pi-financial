...
namespace Pi.BackofficeService.Migrations.Migrations.BackofficeDb
{
    ...
    [Migration("20230620081831_UpdateErrorMappingTable")]
    partial class UpdateErrorMappingTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pi.BackofficeService.Domain.AggregateModels.ResponseCodeAggregate.ErrorHandlerActions", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.HasKey("Id")
                        .HasName("pk_error_handler_actions");

                    b.ToTable("error_handler_actions", (string)null);
                });

            modelBuilder.Entity("Pi.BackofficeService.Domain.AggregateModels.ResponseCodeAggregate.ErrorMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_error_mappings");

                    b.ToTable("error_mappings", (string)null);
                });
