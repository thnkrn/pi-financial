...
namespace Pi.SetMarketDataWSS.SignalRHub.Tests
{
    ...
    {
        private readonly Mock<IStreamingMarketDataSubscriber> _mockSubscriber;
        private readonly Mock<ILogger<StreamingHub>> _mockLogger;
        ...
        {
            _mockSubscriber = new Mock<IStreamingMarketDataSubscriber>();
            _mockLogger = new Mock<ILogger<StreamingHub>>();
        ...
        {
            // Arrange
            var hub = new StreamingHub(_mockSubscriber.Object, _mockLogger.Object, _mockConfiguration.Object)
            {
        ...
        {
            // Arrange
            var mockAsyncDisposableSubscriber = new Mock<IStreamingMarketDataSubscriber>();
            mockAsyncDisposableSubscriber.As<IAsyncDisposable>();
            var hub = new StreamingHub(mockAsyncDisposableSubscriber.Object, _mockLogger.Object, _mockConfiguration.Object);
