...
public class TimelineRenderedResponse
{
    ...
    [JsonPropertyName("data")] public List<List<object>>? Data { get; set; }

    [JsonPropertyName("intermissions")] public List<Intermission>? Intermissions { get; set; }

    [JsonPropertyName("meta")] public TimelineMeta? Meta { get; set; }
}
...
public class MarketTimelineRenderedResponse
{
    ...
    [JsonPropertyName("response")] public TimelineRenderedResponse? Response { get; set; }
