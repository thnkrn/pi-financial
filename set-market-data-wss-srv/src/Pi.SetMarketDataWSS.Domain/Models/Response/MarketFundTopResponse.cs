...
public class TopInstrumentList
{
    ...
    [JsonPropertyName("fundCategory")] public string? FundCategory { get; set; }
    ...
    [JsonPropertyName("returnPercentage")] public string? ReturnPercentage { get; set; }

    [JsonPropertyName("isFavorite")] public bool IsFavorite { get; set; }

    [JsonPropertyName("asOfDate")] public string? AsOfDate { get; set; }
...
{
    [JsonPropertyName("instrumentList")] public List<TopInstrumentList>? InstrumentList { get; set; }
}
...
public class MarketFundTopResponse
{
    ...
    [JsonPropertyName("response")] public FundTopResponse? Response { get; set; }
}