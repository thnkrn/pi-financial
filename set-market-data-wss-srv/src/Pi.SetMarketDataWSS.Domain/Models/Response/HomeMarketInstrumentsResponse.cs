...
{
    [JsonPropertyName("instrumentList")] public List<InstrumentList>? InstrumentList { get; set; }
}

public class HomeMarketInstrumentsResponse
{
    [JsonPropertyName("code")] public string? Code { get; set; }

    [JsonPropertyName("message")] public string? Message { get; set; }

    [JsonPropertyName("response")] public InstrumentsResponse? Response { get; set; }
