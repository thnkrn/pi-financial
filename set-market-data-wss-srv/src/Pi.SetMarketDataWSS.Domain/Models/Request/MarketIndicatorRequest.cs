...
{
    [JsonPropertyName("boll")] public string? Boll { get; set; }

    [JsonPropertyName("ema")] public string? Ema { get; set; }

    [JsonPropertyName("kdj")] public string? Kdj { get; set; }

    [JsonPropertyName("ma")] public string? Ma { get; set; }

    [JsonPropertyName("macd")] public string? Macd { get; set; }

    [JsonPropertyName("rsi")] public string? Rsi { get; set; }
}
...
public class MarketIndicatorRequest
{
    ...
    [JsonPropertyName("fromTimestamp")] public int FromTimestamp { get; set; }

    [JsonPropertyName("indicators")] public Indicators? Indicators { get; set; }

    [JsonPropertyName("symbol")] public string? Symbol { get; set; }

    [JsonPropertyName("toTimestamp")] public int ToTimestamp { get; set; }
