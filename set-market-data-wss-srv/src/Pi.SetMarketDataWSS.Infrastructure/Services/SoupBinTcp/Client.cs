...
using Pi.SetMarketDataWSS.Infrastructure.Services.SoupBinTcp.Handlers;

namespace Pi.SetMarketDataWSS.Infrastructure.Services.SoupBinTcp;
...
public class Client : IClient
{
    ...
    private bool IsChannelInactive
    {
        get
        {
            if (_clientChannel == null) return true;
    ...
    {
        if (_clientChannel is { Active: true }) await _clientChannel.WriteAndFlushAsync(new UnSequencedData(message));
    }
