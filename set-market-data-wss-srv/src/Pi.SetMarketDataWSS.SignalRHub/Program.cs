...
using Pi.SetMarketDataWSS.SignalRHub.Startup;
using Serilog;
...
try
{
    ...
    var hostBuilder = Host.CreateDefaultBuilder(args)
        ...
        .UseSerilog((context, _, loggerConfiguration) =>
        {
            ...
            {
                ServiceType = "Worker",
                Component = "SetMarketDataWSSSignalRHub",
        ...
        .ConfigureServices((hostContext, services) =>
        {
            ...
            services.AddHealthChecks().AddCheck<StreamingMarketDataSubscriberHealthCheck>("set_streaming_subscriber");
        })
