...
public sealed class StreamingHub : Hub, IAsyncDisposable
{
    private readonly ActivitySource _activitySource;
    private readonly ILogger<StreamingHub> _logger;
    private readonly string _methodName;
    private readonly IStreamingMarketDataSubscriber _subscriber;

    /// <inheritdoc />
    public StreamingHub(IStreamingMarketDataSubscriber subscriber, ILogger<StreamingHub> logger,
        IConfiguration configuration)
    {
        ...
        _activitySource = new ActivitySource("StreamingHub");
    }
