...
public class VelexaModel
{
    public class OrderRequest
    {
        ...
        public LowerString side { get; init; }
        public string quantity { get; init; }
        public LowerString orderType { get; init; }
        public string stopPrice { get; init; }
        public string limitPrice { get; init; }
        public LowerString duration { get; init; }
    ...
    public static class OperationTypeGroup
    {
        public const string OrderTransaction = "TRADE,AUTOCONVERSION,COMMISSION";
        public const string CorporateAction = "STOCK SPLIT,DIVIDEND,US TAX,TAX,CORPORATE ACTION,AUTOCONVERSION";
    }
