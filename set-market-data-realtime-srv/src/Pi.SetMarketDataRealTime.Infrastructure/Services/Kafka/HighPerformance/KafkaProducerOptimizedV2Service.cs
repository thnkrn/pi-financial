...
public sealed class KafkaProducerOptimizedV2Service : IKafkaProducerOptimizedV2Service, IDisposable
{
        ...
        ILogger<KafkaProducerOptimizedV2Service> logger)
    {
        ...
        var config = new ProducerConfig
        {
            ...
            // Message settings
            MessageSendMaxRetries = 0, // Don't retry - let application code handle retries
            MessageTimeoutMs = 10000, // 10 seconds timeout
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            // Queue the message to the producer without awaiting
            ...
            _logger.LogInformation("Batch of {Count} messages sent to topic {Topic} in {ElapsedMs}ms",
