...
public class SystemEventMessageTests
{
    ...
    public async Task SystemEventMessage_Constructor_SetsInputCorrectly(
        byte[] input,
        object[] result
    )
    {
        // Arrange
        // Act
        var output = await itchParserService.Parse(input) as SystemEventMessage;
    ...
    [Fact]
    public async Task SystemEventMessage_Constructor_SetsInputWithIncorrectFormat()
    {
        // Arrange
