...
public class HaltInformationMessageTests
{
    ...
    public async Task HaltInformationMessage_Constructor_SetsInputCorrectly(
        byte[] input,
        object[] result
    )
    {
        ...
        var output =
            await itchParserService.Parse(input) as HaltInformationMessage;
    ...
    [Fact]
    public async Task HaltInformationMessage_Constructor_SetsInputWithIncorrectFormat()
    {
        // Arrange
